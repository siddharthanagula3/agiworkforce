...
- IMPORTANT (post-incident): write findings ONLY via the Write/Edit tools to your own AUDIT_PARTS/batch-NNN.md file — do not use Bash heredocs/appends for findings.
