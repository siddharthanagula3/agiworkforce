...
| [docs/current/README.md](docs/current/README.md)                                 | Compact current product, architecture, commercial, and repo-operability docs       |
| [docs/current/product-suite.md](docs/current/product-suite.md)                   | Product thesis, trust modes, surfaces, and sync boundary                           |
| [docs/current/technical-architecture.md](docs/current/technical-architecture.md) | Cross-surface architecture and monorepo ownership                                  |
| [docs/current/commercial-and-launch.md](docs/current/commercial-and-launch.md)   | Commercial posture, waitlist gates, managed compute, and enterprise launch rules   |
| [docs/current/agent-and-repo-operability.md](docs/current/agent-and-repo-operability.md) | A+ repo organization, docs, and parallel-agent workflow                     |
...
- **New contributor?** Read this top to bottom, then [BUILD.md](BUILD.md) + [docs/current/README.md](docs/current/README.md).
- **Picking up where someone left off?** Check [PLAN.md](PLAN.md) and [TODO.md](TODO.md) for current strategy and execution.
...
Don't update this file for: in-progress work (use [PLAN.md](PLAN.md) and [TODO.md](TODO.md)), individual fixes (use commit messages + [docs/audit/FIX_QUEUE.md](docs/audit/FIX_QUEUE.md)).
