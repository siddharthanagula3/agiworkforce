...
| Desktop | Managed-cloud account shell with approved local folders, device tools, artifacts, computer use, and desktop approvals; no Local or BYOK inference.           |
...
| Desktop | Managed-cloud chat, approved local files, generated-file manifests, computer-use approvals, and Mobile/Desktop handoff host.                                                          | Expose Local/BYOK inference or accept provider keys in the public Electron shell.                        |
...
Normal app chat sync is shared by Web, Mobile Cloud, and Desktop. Chrome keeps
