...
| Founder asked for GPT-6 Astra and Claude Fable 5.1 in the catalogue                    | done 4cacda1c5: Astra added from the provider's published pages (flagship band, no task route, so Auto is unchanged); Fable 5.1 was already curated on 2026-09-04 and rechecked; the OpenAI roster guard now asserts no orphan instead of set equality |
