...
| Served by receipt on the web transcript | /chat/[id]          | message routing metadata                          | missing: the web bubble renders no provenance line (desktop does); escalation line in flight, full receipt is a gated follow-up |
