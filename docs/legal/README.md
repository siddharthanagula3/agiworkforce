...
Purpose: legal/compliance source docs, policy drafts, review notes, and license/compliance operating guidance.
...
3. **Do not promise emailed notice.** There is no transactional email provider
   anywhere in this repository. Notice is the policy page plus `/changelog`.
