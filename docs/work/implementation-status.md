...
only; they do not authorize public Local, BYOK, provider-key, or local-MCP
claims for Desktop.
...
| Chat/history                      | Present              | Present in Managed Cloud through the public Electron shell; retained Tauri Local/BYOK paths are internal only              | Present across Local/Cloud | Developer sessions, not consumer history                                                                                             | Developer sessions through CLI app-server | Separate browser-task history            |
