...
| QA-WEB-MOBILE-NAV-OFFSCREEN        | P1 responsive       | Historical 390×844 capture placed New Chat, AGI Code and Search at negative x coordinates while Chat began on-screen.                                                                                                                                                      | Primary navigation actions remain visible and reachable without hidden horizontal displacement.         | Current signed-in Chromium regression passes at 390px and 320px; historical failure no longer reproduced in those two widths. Other engines remain unchecked. |
