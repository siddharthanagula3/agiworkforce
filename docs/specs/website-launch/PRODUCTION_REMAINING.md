...
| Correct schema and grants           | Local ledger currently has272 applied,0273 pending and a checksum drift at0268; earlier through272 adapter/authorization probes remain retained | Production verified through 0273 on 2026-09-20; zero pending and zero drift | Production schema and 13 invariant checks passed; see deployment handoff for snapshot, backup and clone evidence. Local checksum drift remains a separate reconciliation task. | Data loss and unavailable features  |
...
Production migration recovery and verification evidence: [deployment handoff](../../work/deployment-handoff-2026-09-19.md). The object-storage backup release gap remains open.
