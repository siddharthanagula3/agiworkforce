...
9. `bug-finding-guide.md` - workflow for finding bugs without getting lost in stale docs.
10. `agent-task-templates.md` - standard prompts for exploration, implementation, review, and verification agents.
