...
- Root source-of-truth docs: `AGENTS.md`, `CLAUDE.md`, `PLAN.md`, `TODO.md`, `CHANGELOG.md`, `BUILD.md`.
...
5. Supabase migrations are append-only and require backend/data plus security/privacy review.
