...
| DOC-CLAIM-01     | Medium   | Open         | Docs + desktop    | `docs/current/`, `AGENTS.md`, `CLAUDE.md`, `apps/desktop/src/App.tsx`    | Archived docs may disagree on whether parts of `UnifiedAgenticChat` are dead or partially live. Verify before deleting any desktop chat files. | `rg "UnifiedAgenticChat" apps/desktop docs AGENTS.md CLAUDE.md` |
