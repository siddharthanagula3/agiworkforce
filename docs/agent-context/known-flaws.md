...
| DOC-DRIFT-01     | Medium   | Open         | Docs              | `docs/plans/`, `docs/planning/`, `docs/archive/`, `tasks/research/`      | Current, historical, working, and generated docs are still mixed. `doc-status.json` is the interim index.                               | `pnpm check:agent-context`                                         |
...
| DX-README-01     | Medium   | Open         | Platform          | `apps/`, `packages/`, `crates/`, `services/`                             | Most packages, crates, and services lack local README files with owner, purpose, public API, and test commands.                         | See `audit/repo-organization/current-monorepo-grade-2026-05-20.md` |
...
| ORG-GENERATED-01 | Medium   | Open debt    | Platform          | `.playwright-mcp/`, `reports/`, `audit/reports/`, root screenshots       | Generated captures and reports need retention and tracking policy before release.                                                       | `git ls-files                                                      | rg 'playwright-mcp | reports | \\.png$'` |
