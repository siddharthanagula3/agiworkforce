...
Use the fact-checked numbers below. Anthropic's Opus 5 row was reverified
2026-07-25; the remaining figures retain their stated source dates. Pricing is
fast-moving, so re-verify before hardcoding. "Discount" = cached input billed
as a fraction of standard input.

| Provider                     | Auto / Explicit                                                                                                            | Cached-input (read) discount                                                                                                                                         | Cache write cost                                                                      | TTL                                                                           | Min cacheable tokens                                                                                                     | Source                                                                                                                                                                                        |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **anthropic**                | Both (single top-level `cache_control` = auto; per-block = explicit; max 4 breakpoints)                                    | **0.1x** base input (90% off)                                                                                                                                        | 5-min: **1.25x**; 1-hour: **2x** base input                                           | 5 min default; 1 hour optional (`"ttl":"1h"`)                                 | Per-model: Opus 5 512; Opus 4.7 2,048; Opus 4.6/4.5 4,096; Sonnet 4.6/4.5 1,024; Haiku 4.5 4,096; Fable 5 / Mythos 5 512 | [prompt-caching](https://platform.claude.com/docs/en/build-with-claude/prompt-caching), [pricing](https://platform.claude.com/docs/en/about-claude/pricing)                                   |
...
Anthropic per-model absolute prices ($/MTok), CONFIRMED ([pricing](https://platform.claude.com/docs/en/about-claude/pricing)): Opus 5/4.7/4.6/4.5 = $5 in / $6.25 (5m write) / $10 (1h write) / $0.50 read / $25 out. Sonnet 4.6/4.5 = $3 / $3.75 / $6 / $0.30 / $15. Haiku 4.5 = $1 / $1.25 / $2 / $0.10 / $5. Fable 5 + Mythos 5 = $10 / $12.50 / $20 / $1.00 / $50.

Tokenizer caveat affecting effective cost: Anthropic documented an up-to-35%
token-count change for a predecessor Opus generation. Do not apply that drift
factor to Opus 5 unless current provider documentation explicitly does so.
...
- **P3 — verify hardcoded multipliers/min-tokens against §4** (Anthropic minimums differ per
  model: Opus 5 512 vs Haiku 4.5 4,096).
