...
The 2026-07-08 full-repo audit confirmed the monorepo shape below and produced the consolidation plan that governed package/crate ownership. That plan (`docs/plans/monorepo-restructure-2026-07-08.md`), its Rust engine-extraction sub-plan (`docs/plans/rust-engine-extraction-2026-07-09.md`) and the external-brief adjudication (`docs/architecture/shared-packages-decision-log.md`) were all **retired and deleted** once their phases landed — do not go looking for them. This file is now the ownership reference, and `PLAN.md` carries the remaining sequencing; where the two disagree, verify against the tree before trusting either.
