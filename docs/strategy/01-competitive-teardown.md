...
- **Model lineup (mid-2026):** Fable 5 (frontier, above Opus), Mythos 5 (gated cyber-defense sibling), Opus 4.8, Sonnet 4.6, Haiku 4.5. Cadence is itself a weapon — Opus 4.6 → 4.7 → 4.8 plus the Fable line shipped in roughly one quarter; Opus 4.8 came 41 days after 4.7. Pinned-snapshot IDs; a tokenizer change in Opus 4.7+ consumes ~35% more tokens for the same text (a real cost gotcha).
