...
| `AGI-AI-0001`    | Model IDs and capabilities come from `packages/contracts/types/src/models.json` SSOT; never hardcoded.                                                                                                                                                                                                                                                                                      | `CURRENT_DECISIONS.md` #9                                                 | Enforced                                              |
...
| `AGI-COMP-0001`  | EU AI Act Article 50(1)/(2) disclosure + provenance markers; Chinese-HQ provider opt-in gate before any provider request.                                                                                                                                                                                                                                                                   | `packages/contracts/compliance/llm-gate.ts`                               | Enforced                                              |
