...
Source for this section: the lead's own capture, dated 2026-09-05, at
`scratchpad/research/leader-personal-audit-2026-09-05.md`. Grade: Observed
(a person drove both live products today; no URL applies to an internal
capture).
...
- The two leading products differ structurally, not just cosmetically, in
  ...
  See [[claude-ai-ui-reference-2026-09-03]] and
  [[leader-ui-reference-2026-09-04]] for the earlier UI passes this extends.
