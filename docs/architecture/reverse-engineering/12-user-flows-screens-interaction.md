...
| Connector permissions / detail                                                                  | `138_..._connectors-gmail-permissions.png`, `164/167/168_..._connector-*`              | desktop `features/connectors`, `packages/mcp`                                               | Partial                                                |
| Skills customize                                                                                | `139_web-max__customize-skills-humanizer.png`                                          | `.../features/chat/SkillsMenu`, `packages/skills`                                           | Partial                                                |
...
Screens/flows/patterns were read at branch `chore/repo-restructure-2026-07` (HEAD `751877973`). Route paths (`apps/web/app/*`) and components (`apps/web/features/chat/components/*`, `packages/unified-chat/src/components/*`) were confirmed by directory listing/grep; reference screenshots are cited by filename from `/Users/siddhartha/Desktop/reference/claude_reference/`. Status labels reconcile the 2026-07-10 master plan against the 2026-06-27 matrix (newer wins). Re-verify before treating any status as current.
