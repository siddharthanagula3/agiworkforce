...
Pricing is shared across the suite: Free, Basic ($8 · ₹399), Pro ($20), Max ($100 and $200), and Enterprise. There is no Plus or Hobby tier and no top-ups. Local and BYOK are free access modes wherever the surface permits them.
