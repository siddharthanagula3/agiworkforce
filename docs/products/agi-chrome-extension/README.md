...
Pricing follows the shared platform model: Free / Basic ($8·₹399) / Pro ($20) / Max ($100 & $200) / Enterprise. There is no Plus or Hobby tier and no top-ups. Local and BYOK remain free access modes where the surface allows them.
