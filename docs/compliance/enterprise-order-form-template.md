...
| Included usage per period | [Amount] USD-equivalent of managed usage per contract period                                                                                                                                             |
...
| Support tier              | Enterprise, 4-hour first-response target per `/sla` as of [date]. Not a credit-bearing SLA unless a separate SLA Exhibit is attached; see MSA §8.2.                                                      |
...
| Included usage per period | `included_usage_cents_per_period`                                                                                                      | Stored in cents.                                                                                            |
