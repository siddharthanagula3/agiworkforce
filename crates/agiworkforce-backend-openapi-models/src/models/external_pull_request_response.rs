...
pub struct ExternalPullRequestResponse {
    ...
    #[serde(rename = "agiworkforce_updated_sha", skip_serializing_if = "Option::is_none")]
    pub agiworkforce_updated_sha: Option<String>,
}
