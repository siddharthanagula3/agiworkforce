...
use agiworkforce_package_manager::ManagedPackage;
use agiworkforce_package_manager::PackageManager;
use agiworkforce_package_manager::PackageManagerConfig;
use agiworkforce_package_manager::PackageManagerError;
use agiworkforce_package_manager::PackageReleaseArchive;
use reqwest::Client;
use std::path::Path;
...
/// Relative cache root for installed artifact runtimes under `agiworkforce_home`.
...
impl ArtifactRuntimeManagerConfig {
    ...
    pub fn new(agiworkforce_home: PathBuf, release: ArtifactRuntimeReleaseLocator) -> Self {
        Self {
