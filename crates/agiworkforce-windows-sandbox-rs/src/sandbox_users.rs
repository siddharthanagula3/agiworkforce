...
use agiworkforce_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "AgiWorkforceSandboxUsers";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(agiworkforce_home);
    ...
    let secrets_dir = sandbox_secrets_dir(agiworkforce_home);
