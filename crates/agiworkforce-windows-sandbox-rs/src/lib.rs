...
#[cfg(target_os = "windows")]
pub use workspace_acl::protect_workspace_agiworkforce_dir;
...
mod windows_impl {
    ...
    use super::workspace_acl::protect_workspace_agiworkforce_dir;
    use anyhow::Result;
    ...
    pub fn run_windows_sandbox_capture(
        ...
        ensure_agiworkforce_home_exists(agiworkforce_home)?;
        ...
        let (h_token, psid_generic, psid_workspace): (HANDLE, *mut c_void, Option<*mut c_void>) = unsafe {
            match &policy {
                ...
                SandboxPolicy::WorkspaceWrite { .. } => {
                    ...
                    let ws_sid = workspace_cap_sid_for_cwd(agiworkforce_home, cwd)?;
        ...
        unsafe {
            ...
            if let Some(psid) = psid_workspace {
                ...
                let _ = protect_workspace_agiworkforce_dir(&current_dir, psid);
    ...
    pub fn run_windows_sandbox_legacy_preflight(
        ...
        unsafe {
            ...
            let _ = protect_workspace_agiworkforce_dir(&current_dir, psid_workspace);
