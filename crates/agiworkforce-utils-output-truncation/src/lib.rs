//! Helpers for truncating tool and exec output using [`TruncationPolicy`](agiworkforce_protocol::protocol::TruncationPolicy).

use agiworkforce_protocol::models::FunctionCallOutputContentItem;
pub use agiworkforce_utils_string::approx_bytes_for_tokens;
pub use agiworkforce_utils_string::approx_token_count;
pub use agiworkforce_utils_string::approx_tokens_from_byte_count;
use agiworkforce_utils_string::truncate_middle_chars;
use agiworkforce_utils_string::truncate_middle_with_token_budget;

pub use agiworkforce_protocol::protocol::TruncationPolicy;
