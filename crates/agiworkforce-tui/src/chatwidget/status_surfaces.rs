...
impl ChatWidget {
    ...
    /// Clears the terminal title Agiworkforce most recently wrote, if any.
    ///
    ...
    pub(super) fn status_surface_preview_value_for_item(
        ...
        let status_line_item = match item {
            StatusSurfacePreviewItem::AppName => return Some("agiworkforce".to_string()),
            ...
            StatusSurfacePreviewItem::AgiworkforceVersion => StatusLineItem::AgiworkforceVersion,
    ...
    pub(super) fn terminal_title_value_for_item(
        ...
        match item {
            TerminalTitleItem::AppName => Some("agiworkforce".to_string()),
            ...
            TerminalTitleItem::WeeklyLimit => self
                ...
                .map(|value| Self::truncate_terminal_title_part(value, /*max_chars*/ 32)),
            TerminalTitleItem::AgiworkforceVersion => self
                .status_line_value_for_item(&StatusLineItem::AgiworkforceVersion)
                .map(|value| Self::truncate_terminal_title_part(value, /*max_chars*/ 32)),
