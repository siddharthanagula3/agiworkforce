...
async fn submission_includes_configured_permission_profile() {
    ...
    let expected_permission_profile = PermissionProfile::Managed {
        ...
        file_system: agiworkforce_protocol::models::ManagedFileSystemPermissions::Restricted {
            entries: vec![
...
async fn submission_keeps_profile_when_legacy_projection_is_external() {
    ...
    let expected_permission_profile = PermissionProfile::Managed {
        network: agiworkforce_protocol::permissions::NetworkSandboxPolicy::Restricted,
        file_system: agiworkforce_protocol::models::ManagedFileSystemPermissions::Unrestricted,
    };
    let configured = agiworkforce_protocol::protocol::SessionConfiguredEvent {
        session_id: conversation_id,
        forked_from_id: None,
