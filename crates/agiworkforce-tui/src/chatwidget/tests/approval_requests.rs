...
fn app_server_exec_approval_request_preserves_permissions_context() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            approval_id: Some("approval-1".to_string()),
            reason: None,
            network_approval_context: Some(agiworkforce_app_server_protocol::NetworkApprovalContext {
    ...
    assert_eq!(
        ...
        Some(agiworkforce_protocol::protocol::NetworkApprovalContext {
            host: "example.com".to_string(),
            protocol: agiworkforce_protocol::protocol::NetworkApprovalProtocol::Socks5Tcp,
        })
    );
    assert_eq!(
        request.additional_permissions,
        Some(agiworkforce_protocol::models::AdditionalPermissionProfile {
