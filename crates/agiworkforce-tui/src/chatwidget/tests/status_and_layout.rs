...
async fn core_cyber_policy_error_renders_dedicated_notice() {
    ...
    chat.handle_agiworkforce_event(Event {
        ...
        msg: EventMsg::Error(ErrorEvent {
            ...
            agiworkforce_error_info: Some(AgiworkforceErrorInfo::CyberPolicy),
        }),
    });
...
async fn renamed_thread_footer_title_snapshot() {
    ...
    chat.handle_agiworkforce_event(Event {
        id: "rename".to_string(),
        msg: EventMsg::ThreadNameUpdated(agiworkforce_protocol::protocol::ThreadNameUpdatedEvent {
            thread_id,
...
async fn status_line_goal_active_token_budget_footer_snapshot() {
    ...
    chat.handle_server_notification(
        ServerNotification::ThreadGoalUpdated(
            agiworkforce_app_server_protocol::ThreadGoalUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: None,
                goal: test_thread_goal(
                    agiworkforce_app_server_protocol::ThreadGoalStatus::Active,
    ...
    chat.handle_server_notification(
        ServerNotification::ThreadGoalUpdated(
            agiworkforce_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                turn_id: None,
                goal: test_thread_goal(
                    agiworkforce_app_server_protocol::ThreadGoalStatus::Complete,
                    /*token_budget*/ None,
                    /*tokens_used*/ 40_000,
                ),
            },
...
async fn thread_goal_update_for_other_thread_is_ignored() {
    ...
    let mut goal = test_thread_goal(
        agiworkforce_app_server_protocol::ThreadGoalStatus::BudgetLimited,
        /*token_budget*/ Some(50_000),
        /*tokens_used*/ 50_000,
    );
...
fn test_thread_goal(
    status: agiworkforce_app_server_protocol::ThreadGoalStatus,
    token_budget: Option<i64>,
    tokens_used: i64,
) -> agiworkforce_app_server_protocol::ThreadGoal {
    agiworkforce_app_server_protocol::ThreadGoal {
        thread_id: "thread-1".to_string(),
    ...
    chat.handle_server_notification(
        ServerNotification::HookStarted(AppServerHookStartedNotification {
            ...
            run: AppServerHookRunSummary {
                ...
                source: agiworkforce_app_server_protocol::HookSource::User,
                display_order: 0,
...
async fn post_tool_use_hook_events_render_snapshot() {
    assert_hook_events_snapshot(
        agiworkforce_protocol::protocol::HookEventName::PostToolUse,
    ...
    chat.handle_agiworkforce_event(Event {
        ...
        msg: EventMsg::HookStarted(agiworkforce_protocol::protocol::HookStartedEvent {
            ...
            run: agiworkforce_protocol::protocol::HookRunSummary {
                ...
                event_name: agiworkforce_protocol::protocol::HookEventName::PostToolUse,
                ...
                source_path: PathBuf::from(test_path_display("/tmp/hooks.json")).abs(),
                source: agiworkforce_protocol::protocol::HookSource::User,
                display_order: 0,
...
async fn quiet_hook_linger_starts_when_delayed_redraw_reveals_hook() {
    ...
    chat.handle_agiworkforce_event(hook_started_event(
        "post-tool-use:0:/tmp/hooks.json",
        agiworkforce_protocol::protocol::HookEventName::PostToolUse,
    ...
    chat.handle_agiworkforce_event(hook_completed_event(
        "post-tool-use:0:/tmp/hooks.json",
        agiworkforce_protocol::protocol::HookEventName::PostToolUse,
        agiworkforce_protocol::protocol::HookRunStatus::Completed,
        Vec::new(),
    ));
...
async fn blocked_and_failed_hooks_render_feedback_and_errors() {
    ...
    chat.handle_agiworkforce_event(hook_completed_event(
        "pre-tool-use:0:/tmp/hooks.json",
        agiworkforce_protocol::protocol::HookEventName::PreToolUse,
        agiworkforce_protocol::protocol::HookRunStatus::Blocked,
        vec![agiworkforce_protocol::protocol::HookOutputEntry {
            kind: agiworkforce_protocol::protocol::HookOutputEntryKind::Feedback,
    ...
    chat.handle_agiworkforce_event(hook_completed_event(
        ...
        agiworkforce_protocol::protocol::HookEventName::PostToolUse,
        agiworkforce_protocol::protocol::HookRunStatus::Failed,
        vec![agiworkforce_protocol::protocol::HookOutputEntry {
            kind: agiworkforce_protocol::protocol::HookOutputEntryKind::Error,
...
async fn completed_same_id_hook_output_survives_restart() {
    ...
    chat.handle_agiworkforce_event(hook_started_event(
        hook_id,
        agiworkforce_protocol::protocol::HookEventName::Stop,
    ...
    chat.handle_agiworkforce_event(hook_completed_event(
        hook_id,
        agiworkforce_protocol::protocol::HookEventName::Stop,
        agiworkforce_protocol::protocol::HookRunStatus::Stopped,
        vec![agiworkforce_protocol::protocol::HookOutputEntry {
            kind: agiworkforce_protocol::protocol::HookOutputEntryKind::Stop,
    ...
    Event {
        ...
        msg: EventMsg::HookStarted(agiworkforce_protocol::protocol::HookStartedEvent {
            ...
            run: hook_run_summary(
                id,
                event_name,
                agiworkforce_protocol::protocol::HookRunStatus::Running,
                status_message,
                Vec::new(),
            ),
        }),
...
fn hook_completed_event(
    id: &str,
    event_name: agiworkforce_protocol::protocol::HookEventName,
    status: agiworkforce_protocol::protocol::HookRunStatus,
    entries: Vec<agiworkforce_protocol::protocol::HookOutputEntry>,
) -> Event {
    Event {
        id: id.to_string(),
        msg: EventMsg::HookCompleted(agiworkforce_protocol::protocol::HookCompletedEvent {
...
fn hook_run_summary(
    ...
    agiworkforce_protocol::protocol::HookRunSummary {
        ...
        started_at: 1,
        completed_at: (status != agiworkforce_protocol::protocol::HookRunStatus::Running).then_some(2),
        duration_ms: (status != agiworkforce_protocol::protocol::HookRunStatus::Running).then_some(1),
        entries,
    }
}
