...
//! "leave the old title alone" or "clear the title Agiworkforce last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Agiworkforce manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Agiworkforce started managing the title.
