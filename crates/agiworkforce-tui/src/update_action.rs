...
use agiworkforce_install_context::InstallContext;
#[cfg(any(not(debug_assertions), test))]
use agiworkforce_install_context::StandalonePlatform;
    ...
    fn maps_install_context_to_update_action() {
        ...
        assert_eq!(
            UpdateAction::from_install_context(&InstallContext::Standalone {
                ...
                resources_dir: Some(native_release_dir.join("agiworkforce-resources")),
            }),
