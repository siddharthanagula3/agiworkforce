...
const APP_TOOLTIP: &str = "Try the **Agiworkforce App**. Run 'codex app' or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Agiworkforce App**. Run 'codex app' or visit https://chatgpt.com/codex?app-landing-page=true";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Agiworkforce.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, Agiworkforce is included in your plan for free – let’s build together.";
...
/// Pick a random tooltip to show to the user when starting Agiworkforce.
...
pub(crate) mod announcement {
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Agiworkforce currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
    ...
    pub(crate) fn parse_announcement_tip_toml(
        ...
        for raw in announcements {
            ...
            if tip.version_matches(AGIWORKFORCE_CLI_VERSION)
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Agiworkforce TUI.
...
[[announcements]]
content = "Welcome to Agiworkforce! Check out the new onboarding flow."
