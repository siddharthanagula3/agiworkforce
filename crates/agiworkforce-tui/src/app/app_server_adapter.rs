...
#[cfg(test)]
use agiworkforce_protocol::items::ImageGenerationItem;
#[cfg(test)]
        ...
        ServerNotification::Error(notification) => Some((
            ...
            vec![Event {
                ...
                msg: EventMsg::Error(ErrorEvent {
                    ...
                    agiworkforce_error_info: notification
                        .error
                        .agiworkforce_error_info
                        .and_then(app_server_agiworkforce_error_info_to_core),
                }),
            }],
        )),
        ...
        ServerNotification::ThreadRealtimeSdp(notification) => Some((
            ...
            vec![Event {
                ...
                msg: EventMsg::RealtimeConversationSdp(
                    agiworkforce_protocol::protocol::RealtimeConversationSdpEvent {
...
fn token_usage_from_app_server(
    value: agiworkforce_app_server_protocol::TokenUsageBreakdown,
) -> TokenUsage {
    TokenUsage {
...
) -> Option<agiworkforce_protocol::models::WebSearchAction> {
    match action {
        agiworkforce_app_server_protocol::WebSearchAction::Search { query, queries } => {
            Some(agiworkforce_protocol::models::WebSearchAction::Search { query, queries })
        }
        agiworkforce_app_server_protocol::WebSearchAction::OpenPage { url } => {
            Some(agiworkforce_protocol::models::WebSearchAction::OpenPage { url })
        }
        agiworkforce_app_server_protocol::WebSearchAction::FindInPage { url, pattern } => {
            Some(agiworkforce_protocol::models::WebSearchAction::FindInPage { url, pattern })
        }
        agiworkforce_app_server_protocol::WebSearchAction::Other => {
            Some(agiworkforce_protocol::models::WebSearchAction::Other)
        }
    }
}

#[cfg(test)]
fn app_server_agiworkforce_error_info_to_core(
    value: agiworkforce_app_server_protocol::AgiworkforceErrorInfo,
) -> Option<agiworkforce_protocol::protocol::AgiworkforceErrorInfo> {
...
mod tests {
    ...
    use agiworkforce_app_server_protocol::CommandAction;
    ...
    fn bridges_thread_snapshot_turns_for_resume_restore() {
        ...
        assert_eq!(
            error.agiworkforce_error_info,
            Some(agiworkforce_protocol::protocol::AgiworkforceErrorInfo::Other)
        );
            ...
            &Turn {
                ...
                items: vec![
                    ...
                    ThreadItem::WebSearch {
                        ...
                        action: Some(agiworkforce_app_server_protocol::WebSearchAction::Other),
                    },
                    ThreadItem::ImageGeneration {
