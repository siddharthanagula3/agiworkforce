...
use agiworkforce_protocol::mcp::RequestId as McpRequestId;
...
mod tests {
    ...
    use agiworkforce_app_server_protocol::PermissionGrantScope;
    use agiworkforce_app_server_protocol::PermissionsRequestApprovalParams;
    use agiworkforce_app_server_protocol::PermissionsRequestApprovalResponse;
    use agiworkforce_app_server_protocol::RequestId as AppServerRequestId;
    use agiworkforce_app_server_protocol::ServerRequest;
    use agiworkforce_app_server_protocol::ToolRequestUserInputAnswer;
    use agiworkforce_app_server_protocol::ToolRequestUserInputParams;
    use agiworkforce_app_server_protocol::ToolRequestUserInputResponse;
    use agiworkforce_protocol::approvals::ElicitationAction;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: agiworkforce_protocol::request_permissions::RequestPermissionsResponse {
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: agiworkforce_app_server_protocol::GrantedPermissionProfile {
        ...
        let user_input = pending
            .take_resolution(&Op::UserInputAnswer {
                id: "turn-2".to_string(),
                response: agiworkforce_protocol::request_user_input::RequestUserInputResponse {
                    answers: std::iter::once((
                        "question".to_string(),
                        agiworkforce_protocol::request_user_input::RequestUserInputAnswer {
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: agiworkforce_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: agiworkforce_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: agiworkforce_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
    ...
    fn same_turn_user_input_answers_resolve_app_server_requests_fifo() {
        ...
        let response = agiworkforce_protocol::request_user_input::RequestUserInputResponse {
            answers: HashMap::new(),
        };
