...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<agiworkforce_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use agiworkforce_app_server_protocol::HookEventName as AppServerHookEventName;
    use agiworkforce_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use agiworkforce_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use agiworkforce_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use agiworkforce_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use agiworkforce_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use agiworkforce_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use agiworkforce_app_server_protocol::HookScope as AppServerHookScope;
