...
use agiworkforce_utils_string::normalize_markdown_hash_location_suffix;
use dirs::home_dir;
...
///
/// This accepts the path shapes Agiworkforce emits today: `file://` URLs, absolute and relative paths,
