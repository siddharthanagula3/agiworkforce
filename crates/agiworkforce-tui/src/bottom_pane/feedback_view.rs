use agiworkforce_feedback::FEEDBACK_DIAGNOSTICS_ATTACHMENT_FILENAME;
use agiworkforce_feedback::FeedbackDiagnostics;
    ...
    super::SelectionViewParams {
        ...
        items: vec![
            super::SelectionItem {
                name: "Yes".to_string(),
                description: Some(
                    "Share the current Agiworkforce session logs with the team for troubleshooting."
                        .to_string(),
                ),
...
mod tests {
    ...
    use crate::app_event::AppEvent;
    use crate::app_event_sender::AppEventSender;
    use agiworkforce_feedback::FeedbackDiagnostic;
    ...
    fn feedback_success_cell_matches_employee_bug_copy() {
        ...
        assert_eq!(
            rendered,
            "• Feedback uploaded. Please report this in #agiworkforce-feedback:\n\n  http://go/agiworkforce-feedback-internal\n\n  Share this and add some info about your problem:\n    https://go/agiworkforce-feedback/thread-2"
        );
    }
