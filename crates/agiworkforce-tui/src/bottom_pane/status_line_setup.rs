...
impl StatusLineItem {
    ...
    pub(crate) fn description(&self) -> &'static str {
        match self {
            ...
            StatusLineItem::AgiworkforceVersion => "Agiworkforce application version",
    ...
    pub(crate) fn preview_item(self) -> StatusSurfacePreviewItem {
        match self {
            ...
            StatusLineItem::AgiworkforceVersion => StatusSurfacePreviewItem::AgiworkforceVersion,
