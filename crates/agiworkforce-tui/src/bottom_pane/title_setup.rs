...
pub(crate) enum TerminalTitleItem {
    ...
    WeeklyLimit,
    /// Agiworkforce application version.
    AgiworkforceVersion,
...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Agiworkforce app name",
            ...
            TerminalTitleItem::AgiworkforceVersion => "Agiworkforce application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::AgiworkforceVersion => Some(StatusSurfacePreviewItem::AgiworkforceVersion),
    ...
    fn parse_terminal_title_items_accepts_kebab_case_variants() {
        ...
        assert_eq!(
            ...
            Some(vec![
                ...
                TerminalTitleItem::ModelWithReasoning,
                TerminalTitleItem::WeeklyLimit,
                TerminalTitleItem::AgiworkforceVersion,
