...
//!
//! For the detailed burst state machine, see `agiworkforce-rs/tui/src/bottom_pane/paste_burst.rs`.
...
#[cfg(test)]
use agiworkforce_core_skills::model::SkillInterface;
...
impl ChatComposer {
    ...
    pub(crate) fn new_with_config(
        ...
        let mut this = Self {
            ...
            is_zellij: matches!(
                agiworkforce_terminal_detection::terminal_info().multiplexer,
    ...
    fn mention_items(&self) -> Vec<MentionItem> {
            ...
            && let Some(snapshot) = self.connectors_snapshot.as_ref()
        {
            for connector in &snapshot.connectors {
                ...
                let display_name = agiworkforce_connectors::metadata::connector_display_label(connector);
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            "Ask Agiworkforce to do anything".to_string(),
            /*disable_paste_burst*/ false,
        );
        ...
        snapshot_composer_state(
            ...
            |composer| {
                ...
                composer.set_status_line(Some(Line::from(
                    "gpt-5.4 high fast · ~/code/agiworkforce-1 · Context 0% used",
                )));
    ...
    fn set_skill_mentions_refreshes_open_mention_popup() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            ...
            description: "Primary personal Agiworkforce repo skill.".to_string(),
            short_description: None,
            interface: None,
            dependencies: None,
            policy: None,
            path_to_skills_md: skill_path.clone(),
            scope: agiworkforce_protocol::protocol::SkillScope::User,
        }]));
    ...
    fn mention_items_show_plugin_owned_skill_and_app_duplicates() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            ...
            policy: None,
            path_to_skills_md: skill_path.clone(),
            scope: agiworkforce_protocol::protocol::SkillScope::Repo,
        }]));
        composer.set_plugin_mentions(Some(vec![PluginCapabilitySummary {
...
程序员 与 Unicode 同行";
    ...
    fn file_completion_preserves_large_paste_placeholder_elements() {
        ...
        composer.on_file_search_result(
            ...
            vec![FileMatch {
                ...
                match_type: agiworkforce_file_search::MatchType::File,
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("agiworkforce_tui_test_paste_image.png");
