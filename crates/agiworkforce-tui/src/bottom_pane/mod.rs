...
mod tests {
    ...
    fn exec_request() -> ApprovalRequest {
        ApprovalRequest::Exec {
            thread_id: agiworkforce_protocol::ThreadId::new(),
            thread_label: None,
            id: "1".to_string(),
    ...
    fn composer_shown_after_denied_while_task_running() {
        ...
        for y in 1..area.height {
            ...
            if row.contains("Ask Agiworkforce") {
                found_composer = true;
                break;
            }
        }
    ...
    fn esc_with_skill_popup_does_not_interrupt_task() {
        ...
        while let Ok(ev) = rx.try_recv() {
            assert!(
                !matches!(ev, AppEvent::AgiworkforceOp(AppCommand::Interrupt)),
    ...
    fn esc_interrupts_running_task_when_no_popup() {
        ...
        assert!(
            matches!(rx.try_recv(), Ok(AppEvent::AgiworkforceOp(AppCommand::Interrupt))),
