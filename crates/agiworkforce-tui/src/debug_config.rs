...
use agiworkforce_config::NetworkUnixSocketPermissionToml;
...
use agiworkforce_config::WebSearchModeRequirement;
...
mod tests {
    ...
    use agiworkforce_config::FilesystemConstraints;
    use agiworkforce_config::HookEventsToml;
    use agiworkforce_config::HookHandlerConfig;
    use agiworkforce_config::ManagedHooksRequirementsToml;
    use agiworkforce_config::MatcherGroup;
    ...
    use agiworkforce_config::NetworkUnixSocketPermissionToml;
    use agiworkforce_config::NetworkUnixSocketPermissionsToml;
    use agiworkforce_config::RequirementSource;
    use agiworkforce_config::ResidencyRequirement;
    use agiworkforce_config::SandboxModeRequirement;
    ...
    fn debug_config_output_lists_requirement_sources() {
        let requirements_file = if cfg!(windows) {
            absolute_path("C:\\ProgramData\\OpenAI\\Agiworkforce\\requirements.toml")
        } else {
