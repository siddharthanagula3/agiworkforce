...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match agiworkforce_tui::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = agiworkforce_tui::RowBuilder::new(/*target_width*/ 20);
    ...
    agiworkforce_tui::insert_history_lines(&mut term, lines)
