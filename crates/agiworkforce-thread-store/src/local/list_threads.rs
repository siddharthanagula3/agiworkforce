...
use agiworkforce_rollout::parse_cursor;
...
pub(super) async fn list_threads(
    ...
    let sort_key = match params.sort_key {
        ThreadSortKey::CreatedAt => agiworkforce_rollout::ThreadSortKey::CreatedAt,
        ThreadSortKey::UpdatedAt => agiworkforce_rollout::ThreadSortKey::UpdatedAt,
    };
    let sort_direction = match params.sort_direction {
        SortDirection::Asc => agiworkforce_rollout::SortDirection::Asc,
        SortDirection::Desc => agiworkforce_rollout::SortDirection::Desc,
    };
...
async fn list_rollout_threads(
    ...
    params: &ListThreadsParams,
    cursor: Option<&agiworkforce_rollout::Cursor>,
    sort_key: agiworkforce_rollout::ThreadSortKey,
    sort_direction: agiworkforce_rollout::SortDirection,
) -> ThreadStoreResult<agiworkforce_rollout::ThreadsPage> {
