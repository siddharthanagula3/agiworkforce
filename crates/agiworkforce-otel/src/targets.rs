pub(crate) const OTEL_TARGET_PREFIX: &str = "agiworkforce_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "agiworkforce_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "agiworkforce_otel.trace_safe";
