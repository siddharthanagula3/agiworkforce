    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            ...
            common: {
                ...
                auth.env_agiworkforce_api_key_present = self.metadata.auth_env.agiworkforce_api_key_env_present,
                auth.env_agiworkforce_api_key_enabled = self.metadata.auth_env.agiworkforce_api_key_env_enabled,
