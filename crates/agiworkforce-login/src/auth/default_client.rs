...
fn get_originator_value(provided: Option<String>) -> Originator {
    let value = std::env::var(AGIWORKFORCE_INTERNAL_ORIGINATOR_OVERRIDE_ENV_VAR)
        .ok()
        .or(provided)
...
pub fn originator() -> Originator {
    ...
    if std::env::var(AGIWORKFORCE_INTERNAL_ORIGINATOR_OVERRIDE_ENV_VAR).is_ok() {
...
pub fn is_first_party_chat_originator(originator_value: &str) -> bool {
    originator_value == "agiworkforce_atlas" || originator_value == "agiworkforce_chatgpt_desktop"
}

pub fn get_agiworkforce_user_agent() -> String {
...
fn is_sandboxed() -> bool {
    std::env::var("AGIWORKFORCE_SANDBOX").as_deref() == Ok("seatbelt")
}
