...
use agiworkforce_agent_identity::register_agent_task;
...
const AGIWORKFORCE_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR: &str = "AGIWORKFORCE_AGENT_IDENTITY_AUTHAPI_BASE_URL";
...
fn agent_identity_authapi_base_url() -> String {
    env::var(AGIWORKFORCE_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR)
        .ok()
...
mod tests {
    ...
    fn agent_identity_authapi_base_url_prefers_env_value() {
        let _guard = EnvVarGuard::set(
            AGIWORKFORCE_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR,
    ...
    fn agent_identity_authapi_base_url_uses_prod_authapi_by_default() {
        let _guard = EnvVarGuard::remove(AGIWORKFORCE_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR);
        assert_eq!(
            agent_identity_authapi_base_url(),
