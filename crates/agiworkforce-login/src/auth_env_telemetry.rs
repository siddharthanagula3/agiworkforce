...
use agiworkforce_otel::AuthEnvTelemetryMetadata;

use crate::AGIWORKFORCE_API_KEY_ENV_VAR;
...
pub struct AuthEnvTelemetry {
    ...
    pub agiworkforce_api_key_env_present: bool,
    pub agiworkforce_api_key_env_enabled: bool,
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            agiworkforce_api_key_env_present: self.agiworkforce_api_key_env_present,
            agiworkforce_api_key_env_enabled: self.agiworkforce_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    agiworkforce_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        agiworkforce_api_key_env_present: env_var_present(AGIWORKFORCE_API_KEY_ENV_VAR),
        agiworkforce_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*agiworkforce_api_key_env_enabled*/ false);
