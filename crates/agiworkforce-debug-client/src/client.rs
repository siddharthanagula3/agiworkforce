...
impl AppServerClient {
    pub fn spawn(
        ...
        let mut child = cmd
            ...
            .spawn()
            .with_context(|| format!("failed to start `{agiworkforce_bin}` app-server"))?;
    ...
    pub fn initialize(&mut self) -> Result<()> {
        ...
        let request = ClientRequest::Initialize {
            ...
            params: agiworkforce_app_server_protocol::InitializeParams {
        ...
        let _parsed: agiworkforce_app_server_protocol::InitializeResponse =
...
fn handle_server_request(
    ...
    match server_request {
        agiworkforce_app_server_protocol::ServerRequest::CommandExecutionRequestApproval {
            request_id,
            ..
        } => {
