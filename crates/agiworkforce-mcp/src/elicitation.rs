...
//!
//! RMCP clients call into this module when a server asks Agiworkforce to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a Agiworkforce protocol event
