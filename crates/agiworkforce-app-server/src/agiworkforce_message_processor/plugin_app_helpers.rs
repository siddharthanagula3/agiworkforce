...
pub(super) async fn load_plugin_app_summaries(
    ...
    let accessible_connectors =
        ...
        .await
        {
            Ok(status) if status.agiworkforce_apps_ready => status.connectors,
            Ok(_) => {
...
mod tests {
    ...
    #[test]
    fn plugin_apps_needing_auth_returns_empty_when_agiworkforce_apps_is_not_ready() {
