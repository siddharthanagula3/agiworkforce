...
type PendingInterruptQueue = Vec<(
    ConnectionRequestId,
    crate::agiworkforce_message_processor::ApiVersion,
)>;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: agiworkforce_app_server_protocol::Thread,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<AgiworkforceThread>>,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<AgiworkforceThread>) -> bool {
