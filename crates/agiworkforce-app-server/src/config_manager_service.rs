...
use agiworkforce_app_server_protocol::Config as ApiConfig;
use agiworkforce_app_server_protocol::ConfigBatchWriteParams;
use agiworkforce_app_server_protocol::ConfigLayerMetadata;
...
use agiworkforce_app_server_protocol::OverriddenMetadata;
...
use agiworkforce_config::merge_toml_values;
use agiworkforce_core::config::deserialize_config_toml_with_base;
use agiworkforce_core::config::edit::ConfigEdit;
use agiworkforce_core::config::edit::ConfigEditsBuilder;
use agiworkforce_core::config::validate_feature_requirements_for_config_toml;
use agiworkforce_core::path_utils;
use agiworkforce_core::path_utils::SymlinkWritePaths;
use agiworkforce_core::path_utils::resolve_symlink_write_paths;
use agiworkforce_core::path_utils::write_atomically;
...
impl ConfigManager {
    ...
    async fn apply_edits(
        ...
        let allowed_path =
            AbsolutePathBuf::resolve_path_against_base(CONFIG_TOML_FILE, self.agiworkforce_home());
