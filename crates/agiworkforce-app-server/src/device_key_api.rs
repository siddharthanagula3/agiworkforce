...
use agiworkforce_app_server_protocol::DeviceKeyAlgorithm;
use agiworkforce_app_server_protocol::DeviceKeyCreateParams;
use agiworkforce_app_server_protocol::DeviceKeyCreateResponse;
use agiworkforce_app_server_protocol::DeviceKeyProtectionClass;
use agiworkforce_app_server_protocol::DeviceKeyPublicParams;
use agiworkforce_app_server_protocol::DeviceKeyPublicResponse;
use agiworkforce_app_server_protocol::DeviceKeySignParams;
use agiworkforce_app_server_protocol::DeviceKeySignPayload;
use agiworkforce_app_server_protocol::DeviceKeySignResponse;
use agiworkforce_app_server_protocol::JSONRPCErrorError;
use agiworkforce_device_key::DeviceKeyBinding;
use agiworkforce_device_key::DeviceKeyBindingStore;
use agiworkforce_device_key::DeviceKeyCreateRequest;
use agiworkforce_device_key::DeviceKeyError;
use agiworkforce_device_key::DeviceKeyGetPublicRequest;
use agiworkforce_device_key::DeviceKeyInfo;
use agiworkforce_device_key::DeviceKeyProtectionPolicy;
use agiworkforce_device_key::DeviceKeySignRequest;
use agiworkforce_device_key::DeviceKeyStore;
use agiworkforce_device_key::RemoteControlClientConnectionAudience;
use agiworkforce_device_key::RemoteControlClientConnectionSignPayload;
use agiworkforce_device_key::RemoteControlClientEnrollmentAudience;
use agiworkforce_device_key::RemoteControlClientEnrollmentSignPayload;
use agiworkforce_state::DeviceKeyBindingRecord;
...
fn protection_policy_from_params(
    protection_policy: Option<agiworkforce_app_server_protocol::DeviceKeyProtectionPolicy>,
) -> DeviceKeyProtectionPolicy {
    match protection_policy
        .unwrap_or(agiworkforce_app_server_protocol::DeviceKeyProtectionPolicy::HardwareOnly)
    {
        agiworkforce_app_server_protocol::DeviceKeyProtectionPolicy::HardwareOnly => {
            DeviceKeyProtectionPolicy::HardwareOnly
        }
        agiworkforce_app_server_protocol::DeviceKeyProtectionPolicy::AllowOsProtectedNonextractable => {
            DeviceKeyProtectionPolicy::AllowOsProtectedNonextractable
        }
    }
}

fn payload_from_params(payload: DeviceKeySignPayload) -> agiworkforce_device_key::DeviceKeySignPayload {
    match payload {
        DeviceKeySignPayload::RemoteControlClientConnection {
            ...
            token_expires_at,
            scopes,
        } => agiworkforce_device_key::DeviceKeySignPayload::RemoteControlClientConnection(
        ...
        } => agiworkforce_device_key::DeviceKeySignPayload::RemoteControlClientEnrollment(
...
fn remote_control_client_connection_audience_from_protocol(
    audience: agiworkforce_app_server_protocol::RemoteControlClientConnectionAudience,
) -> RemoteControlClientConnectionAudience {
    match audience {
        agiworkforce_app_server_protocol::RemoteControlClientConnectionAudience::RemoteControlClientWebsocket => {
...
fn remote_control_client_enrollment_audience_from_protocol(
    audience: agiworkforce_app_server_protocol::RemoteControlClientEnrollmentAudience,
) -> RemoteControlClientEnrollmentAudience {
    match audience {
        agiworkforce_app_server_protocol::RemoteControlClientEnrollmentAudience::RemoteControlClientEnrollment => {
            RemoteControlClientEnrollmentAudience::RemoteControlClientEnrollment
        }
    }
}

fn algorithm_from_store(algorithm: agiworkforce_device_key::DeviceKeyAlgorithm) -> DeviceKeyAlgorithm {
    match algorithm {
        agiworkforce_device_key::DeviceKeyAlgorithm::EcdsaP256Sha256 => {
...
fn protection_class_from_store(
    protection_class: agiworkforce_device_key::DeviceKeyProtectionClass,
) -> DeviceKeyProtectionClass {
    match protection_class {
        agiworkforce_device_key::DeviceKeyProtectionClass::HardwareSecureEnclave => {
            DeviceKeyProtectionClass::HardwareSecureEnclave
        }
        agiworkforce_device_key::DeviceKeyProtectionClass::HardwareTpm => {
            DeviceKeyProtectionClass::HardwareTpm
        }
        agiworkforce_device_key::DeviceKeyProtectionClass::OsProtectedNonextractable => {
