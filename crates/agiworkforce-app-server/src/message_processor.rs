...
use crate::agiworkforce_message_processor::AgiworkforceMessageProcessor;
use crate::agiworkforce_message_processor::AgiworkforceMessageProcessorArgs;
...
use agiworkforce_analytics::AppServerRpcTransport;
use agiworkforce_app_server_protocol::AppListUpdatedNotification;
use agiworkforce_app_server_protocol::AuthMode as LoginAuthMode;
use agiworkforce_app_server_protocol::ChatgptAuthTokensRefreshParams;
use agiworkforce_app_server_protocol::ChatgptAuthTokensRefreshReason;
use agiworkforce_app_server_protocol::ChatgptAuthTokensRefreshResponse;
...
use agiworkforce_app_server_protocol::DeviceKeyCreateParams;
use agiworkforce_app_server_protocol::DeviceKeyPublicParams;
use agiworkforce_app_server_protocol::DeviceKeySignParams;
use agiworkforce_app_server_protocol::ExperimentalApi;
use agiworkforce_app_server_protocol::ExperimentalFeatureEnablementSetParams;
use agiworkforce_app_server_protocol::ExternalAgentConfigImportCompletedNotification;
use agiworkforce_app_server_protocol::ExternalAgentConfigImportParams;
use agiworkforce_app_server_protocol::ExternalAgentConfigImportResponse;
use agiworkforce_app_server_protocol::ExternalAgentConfigMigrationItem;
use agiworkforce_app_server_protocol::ExternalAgentConfigMigrationItemType;
...
use agiworkforce_app_server_protocol::ModelProviderCapabilitiesReadResponse;
use agiworkforce_app_server_protocol::ServerNotification;
use agiworkforce_app_server_protocol::ServerRequestPayload;
use agiworkforce_app_server_protocol::experimental_required_message;
...
use agiworkforce_login::auth::ExternalAuthRefreshReason;
use agiworkforce_login::auth::ExternalAuthTokens;
use agiworkforce_login::default_client::SetOriginatorError;
...
pub(crate) struct MessageProcessor {
    outgoing: Arc<OutgoingMessageSender>,
    agiworkforce_message_processor: AgiworkforceMessageProcessor,
...
impl MessageProcessor {
    ...
    pub(crate) fn new(args: MessageProcessorArgs) -> Self {
        ...
        let agiworkforce_message_processor = AgiworkforceMessageProcessor::new(AgiworkforceMessageProcessorArgs {
        ...
        if matches!(plugin_startup_tasks, crate::PluginStartupTasks::Start) {
            ...
            let on_effective_plugins_changed =
                agiworkforce_message_processor.effective_plugins_changed_callback((*config).clone());
            thread_manager
                .plugins_manager()
        ...
        let external_agent_config_api =
            ExternalAgentConfigApi::new(config.agiworkforce_home.to_path_buf());
        ...
        Self {
            outgoing,
            agiworkforce_message_processor,
            thread_manager: Arc::clone(&thread_manager),
            config_api,
            device_key_api,
        ...
        Self::run_request_with_context(
            ...
            async {
                let result = async {
                    ...
                    let agiworkforce_request = serde_json::from_value::<ClientRequest>(request_json)
                        .map_err(|err| invalid_request(format!("Invalid request: {err}")))?;
    ...
    pub(crate) fn thread_created_receiver(&self) -> broadcast::Receiver<ThreadId> {
        self.agiworkforce_message_processor.thread_created_receiver()
    }
    ...
    pub(crate) async fn connection_initialized(&self, connection_id: ConnectionId) {
        self.agiworkforce_message_processor
    ...
    pub(crate) async fn drain_background_tasks(&self) {
        self.agiworkforce_message_processor.drain_background_tasks().await;
    }

    pub(crate) async fn cancel_active_login(&self) {
        self.agiworkforce_message_processor.cancel_active_login().await;
    }
    ...
    pub(crate) async fn shutdown_threads(&self) {
        self.agiworkforce_message_processor.shutdown_threads().await;
    }
    ...
    async fn handle_client_request(
        ...
        agiworkforce_request: ClientRequest,
        session: Arc<ConnectionSessionState>,
        ...
        if let ClientRequest::Initialize { request_id, params } = agiworkforce_request {
            // Handle Initialize internally so AgiworkforceMessageProcessor does not have to concern
            ...
            if let Err(error) = set_default_originator(originator.clone()) {
                match error {
                    ...
                    SetOriginatorError::AlreadyInitialized => {
                        ...
                        // TODO(owen): Once we remove support for AGIWORKFORCE_INTERNAL_ORIGINATOR_OVERRIDE,
            ...
            let user_agent = get_agiworkforce_user_agent();
    ...
    async fn dispatch_initialized_client_request(
        ...
        if let Some(reason) = agiworkforce_request.experimental_reason()
        ...
        let serialization_scope = agiworkforce_request.serialization_scope();
    ...
    async fn handle_initialized_client_request(
        ...
        match agiworkforce_request {
            ...
            other => {
                ...
                // inline the full `AgiworkforceMessageProcessor::process_request` future, which
    ...
    async fn handle_config_mutation(&self) {
        self.agiworkforce_message_processor.handle_config_mutation();
    ...
    async fn handle_external_agent_config_import(
        ...
        let agiworkforce_message_processor = self.agiworkforce_message_processor.clone();
        let outgoing = Arc::clone(&self.outgoing);
            ...
            let session_imports = async move {
                if !pending_session_imports.is_empty() {
                    ...
                    for pending_session_import in pending_session_imports {
                        match agiworkforce_message_processor
