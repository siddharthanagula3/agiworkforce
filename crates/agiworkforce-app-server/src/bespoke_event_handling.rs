use crate::agiworkforce_message_processor::ApiVersion;
use crate::agiworkforce_message_processor::read_rollout_items_from_rollout;
use crate::agiworkforce_message_processor::read_summary_from_rollout;
use crate::agiworkforce_message_processor::summary_to_thread;
...
use agiworkforce_app_server_protocol::AccountRateLimitsUpdatedNotification;
use agiworkforce_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use agiworkforce_app_server_protocol::AgentMessageDeltaNotification;
use agiworkforce_app_server_protocol::ApplyPatchApprovalParams;
use agiworkforce_app_server_protocol::ApplyPatchApprovalResponse;
use agiworkforce_app_server_protocol::AgiworkforceErrorInfo as V2AgiworkforceErrorInfo;
use agiworkforce_app_server_protocol::CollabAgentState as V2CollabAgentStatus;
use agiworkforce_app_server_protocol::CollabAgentTool;
use agiworkforce_app_server_protocol::CollabAgentToolCallStatus as V2CollabToolCallStatus;
use agiworkforce_app_server_protocol::CommandAction as V2ParsedCommand;
use agiworkforce_app_server_protocol::CommandExecutionApprovalDecision;
use agiworkforce_app_server_protocol::CommandExecutionOutputDeltaNotification;
...
use agiworkforce_app_server_protocol::CommandExecutionSource;
use agiworkforce_app_server_protocol::CommandExecutionStatus;
use agiworkforce_app_server_protocol::ContextCompactedNotification;
use agiworkforce_app_server_protocol::DeprecationNoticeNotification;
use agiworkforce_app_server_protocol::DynamicToolCallOutputContentItem;
use agiworkforce_app_server_protocol::DynamicToolCallParams;
use agiworkforce_app_server_protocol::DynamicToolCallStatus;
use agiworkforce_app_server_protocol::ErrorNotification;
use agiworkforce_app_server_protocol::ExecCommandApprovalParams;
use agiworkforce_app_server_protocol::ExecCommandApprovalResponse;
use agiworkforce_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use agiworkforce_app_server_protocol::FileChangeApprovalDecision;
use agiworkforce_app_server_protocol::FileChangeOutputDeltaNotification;
use agiworkforce_app_server_protocol::FileChangePatchUpdatedNotification;
use agiworkforce_app_server_protocol::FileChangeRequestApprovalParams;
use agiworkforce_app_server_protocol::FileChangeRequestApprovalResponse;
use agiworkforce_app_server_protocol::FileUpdateChange;
use agiworkforce_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use agiworkforce_app_server_protocol::GuardianWarningNotification;
use agiworkforce_app_server_protocol::HookCompletedNotification;
use agiworkforce_app_server_protocol::HookStartedNotification;
use agiworkforce_app_server_protocol::InterruptConversationResponse;
...
use agiworkforce_app_server_protocol::McpServerElicitationAction;
use agiworkforce_app_server_protocol::McpServerElicitationRequestParams;
use agiworkforce_app_server_protocol::McpServerElicitationRequestResponse;
use agiworkforce_app_server_protocol::McpServerStartupState;
use agiworkforce_app_server_protocol::McpServerStatusUpdatedNotification;
use agiworkforce_app_server_protocol::McpToolCallError;
use agiworkforce_app_server_protocol::McpToolCallResult;
use agiworkforce_app_server_protocol::McpToolCallStatus;
use agiworkforce_app_server_protocol::ModelReroutedNotification;
use agiworkforce_app_server_protocol::ModelVerificationNotification;
use agiworkforce_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use agiworkforce_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use agiworkforce_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use agiworkforce_app_server_protocol::PatchApplyStatus;
use agiworkforce_app_server_protocol::PermissionsRequestApprovalParams;
use agiworkforce_app_server_protocol::PermissionsRequestApprovalResponse;
use agiworkforce_app_server_protocol::PlanDeltaNotification;
use agiworkforce_app_server_protocol::RawResponseItemCompletedNotification;
use agiworkforce_app_server_protocol::ReasoningSummaryPartAddedNotification;
use agiworkforce_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use agiworkforce_app_server_protocol::ReasoningTextDeltaNotification;
...
use agiworkforce_app_server_protocol::SkillsChangedNotification;
use agiworkforce_app_server_protocol::TerminalInteractionNotification;
...
use agiworkforce_app_server_protocol::ThreadRealtimeClosedNotification;
use agiworkforce_app_server_protocol::ThreadRealtimeErrorNotification;
use agiworkforce_app_server_protocol::ThreadRealtimeItemAddedNotification;
use agiworkforce_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use agiworkforce_app_server_protocol::ThreadRealtimeSdpNotification;
use agiworkforce_app_server_protocol::ThreadRealtimeStartedNotification;
use agiworkforce_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use agiworkforce_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use agiworkforce_app_server_protocol::ThreadRollbackResponse;
use agiworkforce_app_server_protocol::ThreadTokenUsage;
use agiworkforce_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use agiworkforce_app_server_protocol::ToolRequestUserInputOption;
use agiworkforce_app_server_protocol::ToolRequestUserInputParams;
use agiworkforce_app_server_protocol::ToolRequestUserInputQuestion;
use agiworkforce_app_server_protocol::ToolRequestUserInputResponse;
use agiworkforce_app_server_protocol::Turn;
use agiworkforce_app_server_protocol::TurnCompletedNotification;
use agiworkforce_app_server_protocol::TurnDiffUpdatedNotification;
use agiworkforce_app_server_protocol::TurnError;
use agiworkforce_app_server_protocol::TurnInterruptResponse;
use agiworkforce_app_server_protocol::TurnPlanStep;
use agiworkforce_app_server_protocol::TurnPlanUpdatedNotification;
use agiworkforce_app_server_protocol::TurnStartedNotification;
use agiworkforce_app_server_protocol::TurnStatus;
use agiworkforce_app_server_protocol::WarningNotification;
use agiworkforce_app_server_protocol::build_command_execution_end_item;
use agiworkforce_app_server_protocol::build_file_change_approval_request_item;
use agiworkforce_app_server_protocol::build_file_change_begin_item;
use agiworkforce_app_server_protocol::build_file_change_end_item;
use agiworkforce_app_server_protocol::build_item_from_guardian_event;
use agiworkforce_app_server_protocol::build_turns_from_rollout_items;
use agiworkforce_app_server_protocol::convert_patch_changes;
use agiworkforce_app_server_protocol::guardian_auto_approval_review_notification;
use agiworkforce_core::AgiworkforceThread;
use agiworkforce_core::ThreadManager;
use agiworkforce_core::find_thread_name_by_id;
use agiworkforce_core::review_format::format_review_findings_block;
use agiworkforce_core::review_prompts;
use agiworkforce_protocol::ThreadId;
use agiworkforce_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
use agiworkforce_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use agiworkforce_protocol::items::parse_hook_prompt_message;
use agiworkforce_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
...
use agiworkforce_protocol::protocol::RealtimeEvent;
use agiworkforce_protocol::protocol::ReviewDecision;
use agiworkforce_protocol::protocol::ReviewOutputEvent;
use agiworkforce_protocol::protocol::TokenCountEvent;
use agiworkforce_protocol::protocol::TurnAbortedEvent;
use agiworkforce_protocol::protocol::TurnCompleteEvent;
use agiworkforce_protocol::protocol::TurnDiffEvent;
use agiworkforce_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            if let ApiVersion::V2 = api_version {
                let (status, error) = match update.status {
                    agiworkforce_protocol::protocol::McpStartupStatus::Starting => {
                        (McpServerStartupState::Starting, None)
                    }
                    agiworkforce_protocol::protocol::McpStartupStatus::Ready => {
                        (McpServerStartupState::Ready, None)
                    }
                    agiworkforce_protocol::protocol::McpStartupStatus::Failed { error } => {
                        (McpServerStartupState::Failed, Some(error))
                    }
                    agiworkforce_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            if let ApiVersion::V2 = api_version {
                ...
                if assessment.status
                    == agiworkforce_protocol::protocol::GuardianAssessmentStatus::InProgress
                ...
                let completion_status = match assessment.status {
                    agiworkforce_protocol::protocol::GuardianAssessmentStatus::Denied
                    | agiworkforce_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                        Some(CommandExecutionStatus::Declined)
                    }
                    agiworkforce_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                        Some(CommandExecutionStatus::Failed)
                    }
                    agiworkforce_protocol::protocol::GuardianAssessmentStatus::InProgress
                    | agiworkforce_protocol::protocol::GuardianAssessmentStatus::Approved => None,
                };
                    ...
                    Err(err) => {
                        ...
                        if let Err(err) = conversation
                            .submit(Op::ResolveElicitation {
                                ...
                                request_id: request.id,
                                decision: agiworkforce_protocol::approvals::ElicitationAction::Cancel,
                                content: None,
                                meta: None,
                            })
                            .await
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                agiworkforce_protocol::protocol::AgentStatus::Errored(_)
                | agiworkforce_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        ...
        EventMsg::CollabWaitingEnd(end_event) => {
            let status = if end_event.statuses.values().any(|status| {
                matches!(
                    status,
                    agiworkforce_protocol::protocol::AgentStatus::Errored(_)
                        | agiworkforce_protocol::protocol::AgentStatus::NotFound
                )
            }) {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let agiworkforce_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
        ...
        EventMsg::Error(ev) => {
            ...
            let agiworkforce_error_info = ev.agiworkforce_error_info.clone();
            ...
            if matches!(
                ...
                Some(CoreAgiworkforceErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                agiworkforce_error_info: ev.agiworkforce_error_info.map(V2AgiworkforceErrorInfo::from),
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(api_version, ApiVersion::V2)
                && matches!(
                    ...
                    agiworkforce_protocol::protocol::ExecCommandSource::UnifiedExecInteraction
                )
            {
                        ...
                        match read_rollout_items_from_rollout(rollout_path.as_path()).await {
                            Ok(items) => {
                                ...
                                thread.status = thread_watch_manager
                                    ...
                                    .await;
                                match find_thread_name_by_id(agiworkforce_home, &conversation_id).await {
                                    Ok(name) => {
                                        thread.name = name;
                                    }
                                    Err(err) => {
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: agiworkforce_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let agiworkforce_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(agiworkforce_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
async fn respond_to_pending_interrupts(
    thread_state: &Arc<Mutex<ThreadState>>,
    outgoing: &ThreadScopedOutgoingMessageSender,
    abort_reason: Option<agiworkforce_protocol::protocol::TurnAbortReason>,
) {
    let pending = {
        let mut state = thread_state.lock().await;
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: agiworkforce_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            agiworkforce_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
fn collab_resume_begin_item(
    begin_event: agiworkforce_protocol::protocol::CollabResumeBeginEvent,
) -> ThreadItem {
...
fn collab_resume_end_item(end_event: agiworkforce_protocol::protocol::CollabResumeEndEvent) -> ThreadItem {
    let status = match &end_event.status {
        agiworkforce_protocol::protocol::AgentStatus::Errored(_)
        | agiworkforce_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        _ => V2CollabToolCallStatus::Completed,
...
mod tests {
    ...
    use anyhow::anyhow;
    use anyhow::bail;
    use agiworkforce_app_server_protocol::AutoReviewDecisionSource;
    use agiworkforce_app_server_protocol::GuardianApprovalReviewStatus;
    ...
    use agiworkforce_protocol::items::HookPromptFragment;
    use agiworkforce_protocol::items::build_hook_prompt_message;
    use agiworkforce_protocol::mcp::CallToolResult;
    use agiworkforce_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use agiworkforce_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    use agiworkforce_protocol::plan_tool::PlanItemArg;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: agiworkforce_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(agiworkforce_protocol::protocol::GuardianRiskLevel::Low),
                Some(agiworkforce_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(agiworkforce_protocol::protocol::GuardianRiskLevel::High),
                Some(agiworkforce_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(agiworkforce_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = agiworkforce_protocol::protocol::GuardianAssessmentAction::Command {
            source: agiworkforce_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                turn_id: String::new(),
                status: agiworkforce_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: agiworkforce_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(agiworkforce_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(agiworkforce_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    agiworkforce_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(agiworkforce_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(agiworkforce_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = agiworkforce_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: agiworkforce_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                target_item_id: None,
                turn_id: "turn-from-assessment".to_string(),
                status: agiworkforce_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&agiworkforce_home).await;
        let thread_manager = Arc::new(
            agiworkforce_core::test_support::thread_manager_with_models_provider_and_home(
        ...
        let agiworkforce_core::NewThread {
            ...
            .start_thread(
                config.clone(),
                agiworkforce_core::thread_store_from_config(&config),
            )
            .await?;
        let thread_state = new_thread_state();
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: agiworkforce_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        let expected = ThreadItem::CollabAgentToolCall {
            ...
            agents_states: [(
                receiver_id,
                V2CollabAgentStatus::from(agiworkforce_protocol::protocol::AgentStatus::NotFound),
            )]
            .into_iter()
            .collect(),
        };
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agiworkforce_error_info: Some(V2AgiworkforceErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agiworkforce_error_info: Some(V2AgiworkforceErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        let rate_limits = RateLimitSnapshot {
            limit_id: Some("agiworkforce".to_string()),
            limit_name: None,
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("agiworkforce"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agiworkforce_error_info: Some(V2AgiworkforceErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            agiworkforce_app_server_protocol::HookPromptFragment {
