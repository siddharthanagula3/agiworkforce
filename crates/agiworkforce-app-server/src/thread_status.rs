...
use agiworkforce_app_server_protocol::ThreadActiveFlag;
...
mod tests {
    ...
    async fn tracks_non_interactive_thread_status() {
        ...
        manager
            .upsert_thread(test_thread(
                ...
                agiworkforce_app_server_protocol::SessionSource::AppServer,
            ))
            .await;
    ...
    async fn status_updates_track_single_thread() {
        ...
        manager
            .upsert_thread(test_thread(
                ...
                agiworkforce_app_server_protocol::SessionSource::Cli,
            ))
            .await;
    ...
    fn test_thread(thread_id: &str, source: agiworkforce_app_server_protocol::SessionSource) -> Thread {
        Thread {
