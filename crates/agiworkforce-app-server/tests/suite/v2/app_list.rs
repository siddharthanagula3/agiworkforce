...
use agiworkforce_app_server_protocol::AppBranding;
use agiworkforce_app_server_protocol::AppInfo;
use agiworkforce_app_server_protocol::AppListUpdatedNotification;
use agiworkforce_app_server_protocol::AppMetadata;
use agiworkforce_app_server_protocol::AppReview;
use agiworkforce_app_server_protocol::AppScreenshot;
...
#[tokio::test]
async fn list_apps_returns_empty_when_workspace_agiworkforce_plugins_disabled() -> Result<()> {
    let connectors = vec![AppInfo {
        id: "beta".to_string(),
        name: "Beta".to_string(),
        description: Some("Beta connector".to_string()),
