...
const SERVER_NAME: &str = "agiworkforce-apps-test";
...
async fn mount_streamable_http_json_rpc(
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(AgiworkforceAppsJsonRpcResponder {
            connector_name,
...
struct AgiworkforceAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
}

impl Respond for AgiworkforceAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let agiworkforce_apps_meta = body.pointer("/params/_meta/_agiworkforce_apps").cloned();
                ...
                ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "result": {
                        ...
                        "structuredContent": {
                            "_agiworkforce_apps": agiworkforce_apps_meta,
                        },
                        "isError": false
                    }
                }))
