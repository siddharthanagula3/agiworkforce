...
impl LocalProcess {
    ...
    async fn start_process(
        ...
        let spawned_result = if params.tty {
            ...
            agiworkforce_utils_pty::spawn_pipe_process(
                program,
                args,
                params.cwd.as_path(),
                &env,
            ...
            agiworkforce_utils_pty::spawn_pipe_process_no_stdin(
                program,
                args,
                params.cwd.as_path(),
                &env,
...
mod tests {
    ...
    use agiworkforce_utils_pty::ProcessDriver;
    ...
    fn dummy_session() -> ExecCommandSession {
        ...
        agiworkforce_utils_pty::spawn_from_driver(ProcessDriver {
            writer_tx,
            stdout_rx,
