use agiworkforce_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use agiworkforce_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use agiworkforce_app_server_protocol::CollabAgentTool;
use agiworkforce_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use agiworkforce_app_server_protocol::CommandAction;
use agiworkforce_app_server_protocol::CommandExecutionSource;
use agiworkforce_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use agiworkforce_app_server_protocol::ErrorNotification;
use agiworkforce_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
...
use agiworkforce_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use agiworkforce_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use agiworkforce_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use agiworkforce_app_server_protocol::WebSearchAction as ApiWebSearchAction;
...
use agiworkforce_exec::AgentMessageItem;
use agiworkforce_exec::AgiworkforceStatus;
use agiworkforce_exec::CollabAgentState;
use agiworkforce_exec::CollabAgentStatus;
use agiworkforce_exec::CollabTool;
use agiworkforce_exec::CollabToolCallItem;
use agiworkforce_exec::CollabToolCallStatus;
use agiworkforce_exec::CollectedThreadEvents;
use agiworkforce_exec::CommandExecutionItem;
use agiworkforce_exec::CommandExecutionStatus;
use agiworkforce_exec::ErrorItem;
use agiworkforce_exec::EventProcessorWithJsonOutput;
use agiworkforce_exec::ExecThreadItem;
use agiworkforce_exec::FileChangeItem;
use agiworkforce_exec::FileUpdateChange as ExecFileUpdateChange;
use agiworkforce_exec::ItemCompletedEvent;
use agiworkforce_exec::ItemStartedEvent;
use agiworkforce_exec::ItemUpdatedEvent;
use agiworkforce_exec::McpToolCallItem;
use agiworkforce_exec::McpToolCallItemError;
use agiworkforce_exec::McpToolCallItemResult;
use agiworkforce_exec::McpToolCallStatus;
use agiworkforce_exec::PatchApplyStatus;
use agiworkforce_exec::PatchChangeKind;
use agiworkforce_exec::ReasoningItem;
use agiworkforce_exec::ThreadErrorEvent;
use agiworkforce_exec::ThreadEvent;
use agiworkforce_exec::ThreadItemDetails;
use agiworkforce_exec::ThreadStartedEvent;
use agiworkforce_exec::TodoItem;
use agiworkforce_exec::TodoListItem;
use agiworkforce_exec::TurnCompletedEvent;
use agiworkforce_exec::TurnFailedEvent;
use agiworkforce_exec::TurnStartedEvent;
use agiworkforce_exec::Usage;
use agiworkforce_exec::WebSearchItem;
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: AgiworkforceStatus::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            agiworkforce_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, AgiworkforceStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        agiworkforce_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: agiworkforce_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
