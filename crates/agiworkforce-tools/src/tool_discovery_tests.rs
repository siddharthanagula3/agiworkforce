...
#[test]
fn filter_tool_suggest_discoverable_tools_for_agiworkforce_tui_omits_plugins() {
    ...
    assert_eq!(
        filter_tool_suggest_discoverable_tools_for_client(discoverable_tools, Some("agiworkforce-tui"),),
