  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("local-plugin".to_string(), "agiworkforce-curated".to_string())
                .unwrap(),
...
fn find_marketplace_plugin_supports_git_subdir_sources() {
  ...
  "plugins": [
    ...
    assert_eq!(
        resolved,
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("remote-plugin".to_string(), "agiworkforce-curated".to_string())
                .unwrap(),
  ...
  "plugins": [
    {{
      ...
      "source": {{
        ...
        assert_eq!(
            err.to_string(),
            "plugin `remote-plugin` was not found in marketplace `agiworkforce-curated`"
        );
    }
}
...
fn find_marketplace_plugin_reports_missing_plugin() {
    ...
    fs::write(
        repo_root.join(".agents/plugins/marketplace.json"),
        r#"{"name":"agiworkforce-curated","plugins":[]}"#,
    )
    .unwrap();
    ...
    assert_eq!(
        err.to_string(),
        "plugin `missing` was not found in marketplace `agiworkforce-curated`"
    );
}
...
fn list_marketplaces_returns_home_and_repo_marketplaces() {
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        vec![
            Marketplace {
                name: "agiworkforce-curated".to_string(),
                path:
  ...
  "plugins": [
    {
      ...
      "policy": {
        ...
        "products": ["AGIWORKFORCE", "CHATGPT", "ATLAS"]
      },
      "category": "Design"
    }
  ]
...
fn find_marketplace_plugin_skips_invalid_local_paths() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `local-plugin` was not found in marketplace `agiworkforce-curated`"
    );
}
...
fn find_installable_marketplace_plugin_rejects_disallowed_product() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `chatgpt-plugin` is not available for install in marketplace `agiworkforce-curated`"
    );
}
...
fn find_marketplace_plugin_allows_missing_products_field() {
  ...
  "plugins": [
    ...
    assert_eq!(resolved.plugin_id.as_key(), "default-plugin@agiworkforce-curated");
}
...
fn find_installable_marketplace_plugin_rejects_explicit_empty_products() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `disabled-plugin` is not available for install in marketplace `agiworkforce-curated`"
    );
}
