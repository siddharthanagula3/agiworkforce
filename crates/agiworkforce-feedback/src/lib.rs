...
#[derive(Clone)]
pub struct AgiWorkforceFeedback {
    inner: Arc<FeedbackInner>,
}

impl Default for AgiWorkforceFeedback {
    fn default() -> Self {
        Self::new()
    }
}

impl AgiWorkforceFeedback {
    pub fn new() -> Self {
...
mod tests {
    ...
    fn ring_buffer_drops_front_when_full() {
        let fb = AgiWorkforceFeedback::with_capacity(8);
        {
    ...
    fn metadata_layer_records_tags_from_feedback_target() {
        let fb = AgiWorkforceFeedback::new();
    ...
    fn feedback_attachments_gate_connectivity_diagnostics() {
        ...
        let snapshot_with_diagnostics = AgiWorkforceFeedback::new()
            .snapshot(None)
        ...
        let attachments_without_diagnostics = AgiWorkforceFeedback::new()
            .snapshot(None)
