...
fn streamable_http_server_bin() -> Result<PathBuf, CargoBinError> {
    agiworkforce_utils_cargo_bin::cargo_bin("test_streamable_http_server")
}
...
fn init_params() -> InitializeRequestParams {
    InitializeRequestParams {
        ...
        client_info: Implementation {
            name: "agiworkforce-test".into(),
            version: "0.0.0-test".into(),
            title: Some("Agiworkforce rmcp recovery test".into()),
            description: None,
            icons: None,
            website_url: None,
        },
...
pub(crate) async fn spawn_exec_server() -> anyhow::Result<ExecServerProcess> {
    ...
    let mut child = Command::new(agiworkforce_utils_cargo_bin::cargo_bin("agiworkforce")?)
