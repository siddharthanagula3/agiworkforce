...
use agiworkforce_config::SkillsConfig;
...
impl SkillsManager {
    pub fn new(agiworkforce_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(agiworkforce_home, bundled_skills_enabled, Some(Product::Agiworkforce))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.agiworkforce_home);
        } else if let Err(err) = install_system_skills(&manager.agiworkforce_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &agiworkforce_config::ConfigLayerStack,
) -> bool {
