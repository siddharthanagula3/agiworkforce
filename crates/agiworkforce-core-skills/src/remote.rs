...
fn as_query_product_surface(product_surface: RemoteSkillProductSurface) -> &'static str {
    match product_surface {
        ...
        RemoteSkillProductSurface::Agiworkforce => "agiworkforce",
        RemoteSkillProductSurface::Api => "api",
        RemoteSkillProductSurface::Atlas => "atlas",
    }
}

fn ensure_agiworkforce_backend_auth(auth: Option<&AgiworkforceAuth>) -> Result<&AgiworkforceAuth> {
...
pub async fn list_remote_skills(
    ...
    let auth = ensure_agiworkforce_backend_auth(auth)?;
...
pub async fn export_remote_skill(
    ...
    let output_dir = agiworkforce_home.join("skills").join(skill_id);
