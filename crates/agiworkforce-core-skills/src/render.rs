...
pub const SKILL_DESCRIPTION_TRUNCATED_WARNING: &str = "Skill descriptions were shortened to fit the skills context budget. Agiworkforce can still see every skill, but some descriptions are shorter. Disable unused skills or plugins to leave more room for the rest.";
pub const SKILL_DESCRIPTION_TRUNCATED_WARNING_WITH_PERCENT: &str = "Skill descriptions were shortened to fit the 2% skills context budget. Agiworkforce can still see every skill, but some descriptions are shorter. Disable unused skills or plugins to leave more room for the rest.";
...
mod tests {
    ...
    fn budgeted_rendering_warns_when_average_description_truncation_exceeds_threshold() {
        ...
        assert_eq!(
            ...
            Some(
                "Skill descriptions were shortened to fit the skills context budget. Agiworkforce can still see every skill, but some descriptions are shorter. Disable unused skills or plugins to leave more room for the rest."
                    .to_string()
            )
        );
    }
