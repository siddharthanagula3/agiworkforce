use crate::default_client::AgiworkforceHttpClient;
use crate::default_client::AgiworkforceRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: AgiworkforceHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<AgiworkforceRequestBuilder, TransportError> {
