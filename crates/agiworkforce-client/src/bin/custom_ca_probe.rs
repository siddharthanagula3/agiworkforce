...
//!
//! The shared reqwest client honors `AGIWORKFORCE_CA_CERTIFICATE` and `SSL_CERT_FILE`, but those
...
//!
//! The detailed explanation of what "hermetic" means here lives in `agiworkforce_client::custom_ca`.
//! This binary exists so the tests can exercise
//! [`agiworkforce_client::build_reqwest_client_for_subprocess_tests`] in a separate process without
