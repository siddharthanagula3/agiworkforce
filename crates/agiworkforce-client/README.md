...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any Agiworkforce/OpenAI awareness.
...
- Consumed by higher-level crates like `agiworkforce-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
