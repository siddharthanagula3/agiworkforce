//! Shared model metadata types exchanged between Agiworkforce services and clients.
//!
...
/// Metadata describing a Agiworkforce-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Agiworkforce backend `/models` endpoint.
