...
use agiworkforce_experimental_api_macros::ExperimentalApi;
use agiworkforce_protocol::account::PlanType;
use agiworkforce_protocol::account::ProviderAccount;
use agiworkforce_protocol::approvals::ElicitationRequest as CoreElicitationRequest;
use agiworkforce_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use agiworkforce_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use agiworkforce_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use agiworkforce_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use agiworkforce_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use agiworkforce_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use agiworkforce_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use agiworkforce_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use agiworkforce_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use agiworkforce_protocol::config_types::CollaborationMode;
use agiworkforce_protocol::config_types::CollaborationModeMask as CoreCollaborationModeMask;
...
use agiworkforce_protocol::config_types::SandboxMode as CoreSandboxMode;
...
use agiworkforce_protocol::config_types::WebSearchToolConfig;
use agiworkforce_protocol::items::AgentMessageContent as CoreAgentMessageContent;
use agiworkforce_protocol::items::TurnItem as CoreTurnItem;
use agiworkforce_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use agiworkforce_protocol::mcp::Resource as McpResource;
pub use agiworkforce_protocol::mcp::ResourceContent as McpResourceContent;
use agiworkforce_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use agiworkforce_protocol::mcp::Tool as McpTool;
use agiworkforce_protocol::memory_citation::MemoryCitation as CoreMemoryCitation;
use agiworkforce_protocol::memory_citation::MemoryCitationEntry as CoreMemoryCitationEntry;
...
use agiworkforce_protocol::models::ManagedFileSystemPermissions as CoreManagedFileSystemPermissions;
...
use agiworkforce_protocol::models::PermissionProfile as CorePermissionProfile;
use agiworkforce_protocol::models::ResponseItem;
use agiworkforce_protocol::openai_models::InputModality;
use agiworkforce_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use agiworkforce_protocol::openai_models::ReasoningEffort;
use agiworkforce_protocol::openai_models::default_input_modalities;
use agiworkforce_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use agiworkforce_protocol::permissions::FileSystemAccessMode as CoreFileSystemAccessMode;
use agiworkforce_protocol::permissions::FileSystemPath as CoreFileSystemPath;
use agiworkforce_protocol::permissions::FileSystemSandboxEntry as CoreFileSystemSandboxEntry;
use agiworkforce_protocol::permissions::FileSystemSpecialPath as CoreFileSystemSpecialPath;
use agiworkforce_protocol::permissions::NetworkSandboxPolicy as CoreNetworkSandboxPolicy;
...
use agiworkforce_protocol::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use agiworkforce_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use agiworkforce_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use agiworkforce_protocol::protocol::HookEventName as CoreHookEventName;
use agiworkforce_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use agiworkforce_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use agiworkforce_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use agiworkforce_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use agiworkforce_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use agiworkforce_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use agiworkforce_protocol::protocol::HookScope as CoreHookScope;
use agiworkforce_protocol::protocol::HookSource as CoreHookSource;
use agiworkforce_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use agiworkforce_protocol::protocol::ModelVerification as CoreModelVerification;
use agiworkforce_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use agiworkforce_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
use agiworkforce_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
use agiworkforce_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use agiworkforce_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use agiworkforce_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use agiworkforce_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use agiworkforce_protocol::protocol::RealtimeAudioFrame as CoreRealtimeAudioFrame;
use agiworkforce_protocol::protocol::RealtimeConversationVersion;
use agiworkforce_protocol::protocol::RealtimeOutputModality;
use agiworkforce_protocol::protocol::RealtimeVoice;
use agiworkforce_protocol::protocol::RealtimeVoicesList;
use agiworkforce_protocol::protocol::ReviewDecision as CoreReviewDecision;
use agiworkforce_protocol::protocol::SessionSource as CoreSessionSource;
use agiworkforce_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use agiworkforce_protocol::protocol::SkillInterface as CoreSkillInterface;
use agiworkforce_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use agiworkforce_protocol::protocol::SkillScope as CoreSkillScope;
use agiworkforce_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
use agiworkforce_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use agiworkforce_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use agiworkforce_protocol::protocol::TokenUsage as CoreTokenUsage;
use agiworkforce_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
use agiworkforce_protocol::user_input::ByteRange as CoreByteRange;
use agiworkforce_protocol::user_input::TextElement as CoreTextElement;
use agiworkforce_protocol::user_input::UserInput as CoreUserInput;
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum AgiworkforceErrorInfo {
...
impl From<CoreAgiworkforceErrorInfo> for AgiworkforceErrorInfo {
    fn from(value: CoreAgiworkforceErrorInfo) -> Self {
        match value {
            ...
            CoreAgiworkforceErrorInfo::CyberPolicy => AgiworkforceErrorInfo::CyberPolicy,
            ...
            CoreAgiworkforceErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                AgiworkforceErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreAgiworkforceErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                AgiworkforceErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreAgiworkforceErrorInfo::Other => AgiworkforceErrorInfo::Other,
        }
    }
}
...
v2_enum_from_core!(
    pub enum ReviewDelivery from agiworkforce_protocol::protocol::ReviewDelivery {
        Inline, Detached
    }
);

v2_enum_from_core!(
    pub enum McpAuthStatus from agiworkforce_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
pub enum ConfigLayerSource {
    ...
    /// User config layer from $AGIWORKFORCE_HOME/config.toml. This layer is special
    ...
    #[ts(rename_all = "camelCase")]
    Project {
        dot_agiworkforce_folder: AbsolutePathBuf,
    },
...
pub enum PermissionProfile {
    /// Agiworkforce owns sandbox construction for this profile.
    #[serde(rename_all = "camelCase")]
    #[ts(rename_all = "camelCase")]
    Managed {
...
impl SandboxPolicy {
    pub fn to_core(&self) -> agiworkforce_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<agiworkforce_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: agiworkforce_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            agiworkforce_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            agiworkforce_protocol::protocol::SandboxPolicy::ReadOnly { network_access, access: _ } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            agiworkforce_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Agiworkforce-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Agiworkforce attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Agiworkforce attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Agiworkforce was previously using.
    ///
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. Agiworkforce Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR AGIWORKFORCE CLOUD - DO NOT USE.
...
impl From<agiworkforce_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: agiworkforce_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> agiworkforce_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => agiworkforce_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => agiworkforce_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `agiworkforce_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
...
pub struct TurnError {
    pub message: String,
    pub agiworkforce_error_info: Option<AgiworkforceErrorInfo>,
    #[serde(default)]
...
impl From<agiworkforce_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: agiworkforce_protocol::models::WebSearchAction) -> Self {
        match value {
            ...
            agiworkforce_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<agiworkforce_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: agiworkforce_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> agiworkforce_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => agiworkforce_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => agiworkforce_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => agiworkforce_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Agiworkforce turn when this elicitation was observed, if app-server could correlate one.
    ///
...
impl From<DynamicToolCallOutputContentItem>
    for agiworkforce_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
...
mod tests {
    ...
    use agiworkforce_protocol::items::ReasoningItem;
    use agiworkforce_protocol::items::TurnItem;
    use agiworkforce_protocol::items::UserMessageItem;
    use agiworkforce_protocol::items::WebSearchItem;
    use agiworkforce_protocol::models::WebSearchAction as CoreWebSearchAction;
    use agiworkforce_protocol::protocol::NetworkAccess as CoreNetworkAccess;
    use agiworkforce_protocol::user_input::UserInput as CoreUserInput;
    ...
    #[test]
    fn agiworkforce_error_info_serializes_http_status_code_in_camel_case() {
        let value = AgiworkforceErrorInfo::ResponseTooManyFailedAttempts {
    ...
    #[test]
    fn agiworkforce_error_info_serializes_cyber_policy_in_camel_case() {
        assert_eq!(
            serde_json::to_value(AgiworkforceErrorInfo::CyberPolicy).unwrap(),
            json!("cyberPolicy")
        );
    }

    #[test]
    fn agiworkforce_error_info_serializes_active_turn_not_steerable_turn_kind_in_camel_case() {
        let value = AgiworkforceErrorInfo::ActiveTurnNotSteerable {
