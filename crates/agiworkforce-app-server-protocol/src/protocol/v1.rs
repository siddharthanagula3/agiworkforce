...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $AGIWORKFORCE_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [agiworkforce_protocol::protocol::PatchApplyBeginEvent]
    /// and [agiworkforce_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [agiworkforce_protocol::protocol::ExecCommandBeginEvent]
    /// and [agiworkforce_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
