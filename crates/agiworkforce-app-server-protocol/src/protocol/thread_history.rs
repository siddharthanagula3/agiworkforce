...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `agiworkforce-rs/core/rollout/policy.rs`.
    ...
    fn reconstructs_tool_items_from_persisted_completion_events() {
        let events = vec![
            ...
            EventMsg::WebSearchEnd(WebSearchEndEvent {
                ...
                query: "agiworkforce".into(),
                action: CoreWebSearchAction::Search {
                    query: Some("agiworkforce".into()),
                    queries: None,
                },
            }),
        ...
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                agiworkforce_protocol::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    namespace: Some("agiworkforce_app".into()),
