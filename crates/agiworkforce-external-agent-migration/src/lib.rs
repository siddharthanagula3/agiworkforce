//! Migration helpers for importing external-agent configuration into Agiworkforce.

use agiworkforce_hooks::HOOK_EVENT_NAMES;
use agiworkforce_hooks::HOOK_EVENT_NAMES_WITH_MATCHERS;
...
"#
    ...
    #[test]
    fn command_skill_names_must_fit_agiworkforce_skill_loader_limit() {
        let root = source_path("commands");
    ...
    #[test]
    fn subagent_requires_minimum_agiworkforce_agent_fields() {
