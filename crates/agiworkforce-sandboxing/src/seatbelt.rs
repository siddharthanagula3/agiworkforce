...
use agiworkforce_network_proxy::PROXY_URL_ENV_KEYS;
use agiworkforce_network_proxy::has_proxy_url_env_vars;
use agiworkforce_network_proxy::proxy_url_env_value;
...
fn create_seatbelt_command_args_with_extensions(
    ...
    create_seatbelt_command_args_for_policies_with_extensions(
        command,
        &FileSystemSandboxPolicy::from_legacy_sandbox_policy_for_cwd(sandbox_policy, sandbox_policy_cwd),
        NetworkSandboxPolicy::from(sandbox_policy),
        sandbox_policy_cwd,
        enforce_managed_network,
        network,
