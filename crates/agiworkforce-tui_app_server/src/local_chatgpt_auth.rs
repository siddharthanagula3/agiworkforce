...
use agiworkforce_core::auth::load_auth_dot_json;
...
mod tests {
    ...
    fn write_chatgpt_auth(agiworkforce_home: &Path) {
        ...
        let auth = AuthDotJson {
            ...
            tokens: Some(TokenData {
                id_token: agiworkforce_core::token_data::parse_chatgpt_jwt_claims(&id_token)
    ...
    fn loads_local_chatgpt_auth_from_managed_auth() {
        ...
        write_chatgpt_auth(agiworkforce_home.path());
