    ...
    fn prompt_snapshot_gpt5_family() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5",
                "gpt-5.1",
                Some("https://www.agiworkforce.com/models/gpt-5.1".to_string()),
                None,
                None,
                "gpt-5.1".to_string(),
    ...
    fn prompt_snapshot_gpt5_codex() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-codex",
                "gpt-5.1-codex-max",
                Some("https://www.agiworkforce.com/models/gpt-5.1-codex-max".to_string()),
                None,
                None,
                "gpt-5.1-codex-max".to_string(),
                Some("Codex-optimized flagship for deep and fast reasoning.".to_string()),
    ...
    fn prompt_snapshot_gpt5_agiworkforce_mini() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-codex-mini",
                "gpt-5.1-codex-mini",
                Some("https://www.agiworkforce.com/models/gpt-5.1-codex-mini".to_string()),
                None,
                None,
    ...
    fn escape_key_accepts_prompt() {
        let mut screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-old",
                "gpt-new",
                Some("https://www.agiworkforce.com/models/gpt-new".to_string()),
                None,
                None,
                "gpt-new".to_string(),
