use anyhow::Context;
use agiworkforce_git_utils::GitBaselineDiff;
use agiworkforce_git_utils::diff_since_latest_init;
use agiworkforce_git_utils::ensure_git_baseline_repository;
...
fn render_workspace_diff_file(diff: &GitBaselineDiff) -> String {
    let mut rendered = String::from(
        "# Memory Workspace Diff\n\n\
         Generated by Agiworkforce before Phase 2 memory consolidation. Read this file first and do not edit it.\n\n\
         ## Status\n",
    );
