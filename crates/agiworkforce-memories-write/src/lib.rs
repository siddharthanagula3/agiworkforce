//! Write-path implementation for Agiworkforce memories.
//!
...
mod guard_limits {
    pub(super) const AGIWORKFORCE_LIMIT_ID: &str = "agiworkforce";
}
...
mod stage_one {
    ...
    pub(super) const REASONING_EFFORT: agiworkforce_protocol::openai_models::ReasoningEffort =
        agiworkforce_protocol::openai_models::ReasoningEffort::Low;
