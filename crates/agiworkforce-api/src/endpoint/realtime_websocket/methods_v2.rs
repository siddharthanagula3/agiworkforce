    ...
    match session_mode {
        RealtimeSessionMode::Conversational => SessionUpdateSession {
            ...
            tools: Some(vec![SessionFunctionTool {
                ...
                name: REALTIME_V2_AGIWORKFORCE_TOOL_NAME.to_string(),
                description: REALTIME_V2_AGIWORKFORCE_TOOL_DESCRIPTION.to_string(),
                parameters: json!({
                    "type": "object",
                    "properties": {
                        "prompt": {
