//! Trace bundle format, writer, and reducer for Agiworkforce rollouts.
//!
//! This crate owns the trace schema. Hot-path Agiworkforce code should depend on the
...
/// Shared recorder context for inference attempts within one Agiworkforce turn.
...
pub use thread::AGIWORKFORCE_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Agiworkforce tool boundary.
...
/// Append-only writer used by hot-path Agiworkforce instrumentation.
