        ...
        match event.payload {
            ...
            RawTraceEventPayload::CodeCellStarted {
                ...
                let thread_id = self.code_cell_event_thread_id(
                    event.thread_id,
                    event.agiworkforce_turn_id.as_deref(),
                    &runtime_cell_id,
                    "code cell start",
                )?;
                ...
                self.start_or_queue_code_cell(PendingCodeCellStart {
                    ...
                    thread_id,
                    agiworkforce_turn_id: event.agiworkforce_turn_id,
            ...
            RawTraceEventPayload::CompactionInstalled {
                ...
                let Some(agiworkforce_turn_id) = event.agiworkforce_turn_id else {
                    bail!(
