...
pub struct RawTraceEvent {
    ...
    pub agiworkforce_turn_id: Option<AgiworkforceTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    AgiworkforceTurnStarted {
        agiworkforce_turn_id: AgiworkforceTurnId,
        thread_id: AgentThreadId,
    },
    AgiworkforceTurnEnded {
        agiworkforce_turn_id: AgiworkforceTurnId,
    ...
    InferenceCancelled {
        ...
        /// before Agiworkforce stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why Agiworkforce stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how Agiworkforce began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how Agiworkforce finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
    ...
    AgentResultObserved {
        ...
        child_agiworkforce_turn_id: AgiworkforceTurnId,
...
impl RawTraceEventPayload {
    ...
    pub(crate) fn raw_payload_refs(&self) -> Vec<&RawPayloadRef> {
        match self {
            ...
            | RawTraceEventPayload::AgiworkforceTurnEnded { .. }
