...
/// Agiworkforce conversation/session UUID.
...
pub type AgiworkforceTurnId = String;
...
/// Process/session ID returned by Agiworkforce's terminal runtime.
...
/// Canonical reduced graph for one Agiworkforce rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Agiworkforce rollout/session being observed. `trace_id`
    ...
    pub agiworkforce_turns: BTreeMap<AgiworkforceTurnId, AgiworkforceTurn>,
...
impl RolloutTrace {
    ...
    pub(crate) fn new(
        ...
        Self {
            ...
            agiworkforce_turns: BTreeMap::new(),
