...
/// Runtime operation requested by the model, a JS code cell, or Agiworkforce itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_agiworkforce_turn_id: Option<AgiworkforceTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Agiworkforce tool boundary.
    ///
    ...
    /// they describe how Agiworkforce executed the request, not what the caller sent.
