use chrono::DateTime;
use chrono::Utc;
use agiworkforce_core::test_support::all_model_presets;
...
pub fn write_models_cache(agiworkforce_home: &Path) -> std::io::Result<()> {
    ...
    write_models_cache_with_models(agiworkforce_home, models)
}
...
pub fn write_models_cache_with_models(
    ...
    let cache_path = agiworkforce_home.join("models_cache.json");
