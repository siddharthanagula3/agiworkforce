use agiworkforce_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use agiworkforce_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
