...
use agiworkforce_core::context::ContextualUserFragment;
use agiworkforce_core::context::PermissionsInstructions;
use agiworkforce_core::load_exec_policy;
...
async fn resume_and_fork_append_permissions_messages() -> Result<()> {
    ...
    let forked = initial
        ...
        .fork_thread(
            ...
            fork_config.clone(),
            agiworkforce_core::thread_store_from_config(&fork_config),
            rollout_path,
