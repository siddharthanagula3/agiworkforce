...
use agiworkforce_core::spawn::AGIWORKFORCE_SANDBOX_ENV_VAR;
...
use agiworkforce_sandboxing::get_platform_sandbox;
use core_test_support::PathExt;
use std::collections::HashMap;
use tempfile::TempDir;

fn skip_test() -> bool {
    if std::env::var(AGIWORKFORCE_SANDBOX_ENV_VAR) == Ok("seatbelt".to_string()) {
        eprintln!("{AGIWORKFORCE_SANDBOX_ENV_VAR} is set to 'seatbelt', skipping test.");
        return true;
    }
