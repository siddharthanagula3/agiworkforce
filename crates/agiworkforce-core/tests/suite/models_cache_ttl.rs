...
use agiworkforce_models_manager::client_version_to_whole;
...
const REMOTE_MODEL: &str = "agiworkforce-test-ttl";
const VERSIONED_MODEL: &str = "agiworkforce-test-versioned";
const MISSING_VERSION_MODEL: &str = "agiworkforce-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "agiworkforce-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let cache_path = config.agiworkforce_home.join(CACHE_FILE);
    ...
    codex
        .submit(Op::UserTurn {
            ...
            approval_policy: agiworkforce_protocol::protocol::AskForApproval::Never,
