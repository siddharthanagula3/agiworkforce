...
use agiworkforce_api::common::Reasoning;
use agiworkforce_api::common::ResponsesWsRequest;
use agiworkforce_api::create_text_param_for_request;
use agiworkforce_api::error::ApiError;
use agiworkforce_api::requests::responses::Compression;
...
impl ModelClient {
    ...
    async fn current_client_setup(&self) -> Result<CurrentClientSetup> {
        ...
        let api_provider = self
            .state
            .provider
            .to_api_provider(auth.as_ref().map(AgiWorkforceAuth::auth_mode))?;
