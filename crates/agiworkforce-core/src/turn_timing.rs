...
use agiworkforce_otel::metrics::names::TURN_TTFM_DURATION_METRIC;
use agiworkforce_otel::metrics::names::TURN_TTFT_DURATION_METRIC;
        ...
        ResponseItem::Reasoning {
            ...
            summary.iter().any(|entry| match entry {
                ...
                entries.iter().any(|entry| match entry {
                    ...
                    | agiworkforce_protocol::models::ReasoningItemContent::Text { text } => {
                        !text.is_empty()
                    }
                })
            })
