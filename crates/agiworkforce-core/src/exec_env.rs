...
pub use agiworkforce_protocol::shell_environment::AGIWORKFORCE_THREAD_ID_ENV_VAR;
...
///
/// `AGIWORKFORCE_THREAD_ID` is injected when a thread id is provided, even when
/// `include_only` is set.
pub fn create_env(
