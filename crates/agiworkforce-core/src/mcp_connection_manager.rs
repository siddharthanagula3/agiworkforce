...
//!
//! The [`McpConnectionManager`] owns one [`agiworkforce_rmcp_client::RmcpClient`] per
...
use agiworkforce_protocol::approvals::ElicitationRequest;
...
use agiworkforce_rmcp_client::SendElicitation;
