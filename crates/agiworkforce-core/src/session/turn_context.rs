...
use agiworkforce_sandboxing::policy_transforms::effective_network_sandbox_policy;
use std::sync::atomic::AtomicBool;
use std::sync::atomic::Ordering;

pub(super) fn image_generation_tool_auth_allowed(auth_manager: Option<&AuthManager>) -> bool {
    auth_manager.is_some_and(AuthManager::current_auth_uses_agiworkforce_backend)
}
...
pub(crate) struct TurnContext {
    ...
    pub(crate) agiworkforce_self_exe: Option<PathBuf>,
...
impl TurnContext {
    ...
    pub(crate) fn apps_enabled(&self) -> bool {
        ...
        self.features.apps_enabled_for_auth(current_auth.as_ref())
    }
    ...
    pub(crate) async fn with_model(
        ...
        Self {
            ...
            agiworkforce_self_exe: self.agiworkforce_self_exe.clone(),
    ...
    pub(crate) fn file_system_sandbox_context(
        ...
        let additional_permissions_simple: Option<agiworkforce_protocol::models::SimplePermissionProfile> =
            additional_permissions.map(Into::into);
        let file_system_sandbox_policy = effective_file_system_sandbox_policy(
            &base_file_system_sandbox_policy,
            additional_permissions_simple.as_ref(),
        );
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        TurnContext {
            ...
            agiworkforce_self_exe: per_turn_config.agiworkforce_self_exe.clone(),
    ...
    pub(crate) async fn new_turn_with_sub_id(
    ...
    ) -> AgiworkforceResult<Arc<TurnContext>> {
        let update_result: AgiworkforceResult<_> = {
            ...
            match state.session_configuration.clone().apply(&updates) {
                ...
                Err(err) => Err(AgiworkforceErr::InvalidRequest(err.to_string())),
            }
        };
        ...
        let (
            ...
            Err(err) => {
                ...
                .await;
                return Err(AgiworkforceErr::InvalidRequest(message));
            }
        };
    ...
    fn resolve_turn_environments(
    ...
    ) -> AgiworkforceResult<Vec<TurnEnvironment>> {
        ...
        for selected_environment in environments {
            ...
            let environment = self
                ...
                .ok_or_else(|| {
                    AgiworkforceErr::InvalidRequest(format!(
