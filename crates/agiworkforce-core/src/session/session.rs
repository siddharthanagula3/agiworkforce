...
pub(crate) struct SessionConfiguration {
    ...
    /// Directory containing all Agiworkforce state for this session.
    pub(super) agiworkforce_home: AbsolutePathBuf,
...
impl SessionConfiguration {
    pub(crate) fn agiworkforce_home(&self) -> &AbsolutePathBuf {
    ...
    pub(crate) async fn new(
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let trace_agent_path = session_configuration
                .session_source
                .get_agent_path()
                .unwrap_or_else(agiworkforce_protocol::AgentPath::root);
            let trace_task_name =
            ...
            let thread_name =
                thread_title_from_state_db(state_db_ctx.as_ref(), &config.agiworkforce_home, conversation_id)
                    .instrument(info_span!(
            ...
            let installation_id = resolve_installation_id(&config.agiworkforce_home).await?;
            ...
            let session_start_source = match &initial_history {
                ...
                InitialHistory::Cleared => agiworkforce_hooks::SessionStartSource::Clear,
            };
