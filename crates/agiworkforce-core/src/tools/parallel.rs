...
impl ToolCallRuntime {
    ...
    pub(crate) fn find_spec(&self, tool_name: &agiworkforce_tools::ToolName) -> Option<ToolSpec> {
    ...
    pub(crate) fn handle_tool_call(
    ...
    ) -> impl std::future::Future<Output = Result<ResponseInputItem, AgiworkforceErr>> {
        ...
        async move {
            match future.await {
                ...
                Err(FunctionCallError::Fatal(message)) => Err(AgiworkforceErr::Fatal(message)),
        ...
        match call.payload {
            ...
            ToolPayload::Custom { .. } => ResponseInputItem::CustomToolCallOutput {
                ...
                output: agiworkforce_protocol::models::FunctionCallOutputPayload {
                    body: agiworkforce_protocol::models::FunctionCallOutputBody::Text(message),
                    success: Some(false),
                },
            },
