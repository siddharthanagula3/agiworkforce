...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub agiworkforce_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
    ...
    pub fn env_for(
        ...
        self.manager
            .transform(SandboxTransformRequest {
                ...
                agiworkforce_linux_sandbox_exe: self
            ...
            .map(|request| {
                let windows_sandbox_policy_cwd =
                    agiworkforce_utils_absolute_path::AbsolutePathBuf::try_from(
                        self.sandbox_cwd.to_path_buf(),
                    )
                    .unwrap_or_else(|_| self.sandbox_cwd.clone());
