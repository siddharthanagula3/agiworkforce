...
//!
//! `agiworkforce-rollout-trace` owns the event schema and writer behavior. This module
...
use agiworkforce_rollout_trace::ToolDispatchInvocation;
use agiworkforce_rollout_trace::ToolDispatchPayload;
use agiworkforce_rollout_trace::ToolDispatchRequester;
use agiworkforce_rollout_trace::ToolDispatchResult;
use agiworkforce_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        agiworkforce_turn_id: invocation.turn.sub_id.clone(),
