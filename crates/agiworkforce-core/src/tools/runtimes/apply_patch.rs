...
impl ApplyPatchRuntime {
    ...
    fn build_sandbox_command(
        req: &ApplyPatchRequest,
        _agiworkforce_home: &std::path::Path,
        ...
        Ok(SandboxCommand {
            ...
            args: vec![
                AGIWORKFORCE_CORE_APPLY_PATCH_ARG1.to_string(),
...
impl ToolRuntime<ApplyPatchRequest, ExecToolCallOutput> for ApplyPatchRuntime {
    async fn run(
        ...
        let command = Self::build_sandbox_command(req, &ctx.turn.config.agiworkforce_home)?;
