...
use agiworkforce_protocol::protocol::ExecApprovalRequestSkillMetadata;
...
use agiworkforce_shell_escalation::Permissions as EscalatedPermissions;
...
impl CoreShellCommandExecutor {
    ...
    fn prepare_sandboxed_exec(
        ...
        let exec_request = sandbox_manager.transform(SandboxTransformRequest {
            ...
            #[cfg(target_os = "macos")]
            macos_seatbelt_profile_extensions,
            agiworkforce_linux_sandbox_exe: self.agiworkforce_linux_sandbox_exe.as_ref(),
