...
fn handler_looks_up_namespaced_aliases_explicitly() {
    ...
    let namespace = "mcp__agiworkforce_apps__gmail";
    let tool_name = "gmail_get_recent_emails";
    let plain_name = agiworkforce_tools::ToolName::plain(tool_name);
    let namespaced_name = agiworkforce_tools::ToolName::namespaced(namespace, tool_name);
    ...
    let missing_namespaced = registry.handler(&agiworkforce_tools::ToolName::namespaced(
