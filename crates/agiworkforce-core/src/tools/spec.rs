...
use agiworkforce_tools::ToolHandlerKind;
use agiworkforce_tools::ToolName;
use agiworkforce_tools::ToolNamespace;
use agiworkforce_tools::ToolRegistryPlanDeferredTool;
use agiworkforce_tools::ToolRegistryPlanMcpTool;
use agiworkforce_tools::ToolRegistryPlanParams;
use agiworkforce_tools::ToolUserShellType;
use agiworkforce_tools::ToolsConfig;
use agiworkforce_tools::WaitAgentTimeoutOptions;
use agiworkforce_tools::augment_tool_spec_for_code_mode;
use agiworkforce_tools::build_tool_registry_plan;
...
pub(crate) fn build_specs_with_discoverable_tools(
    ...
    for unavailable_tool in unavailable_called_tools {
        ...
        if existing_spec_names.insert(tool_name.clone()) {
            let spec = agiworkforce_tools::ToolSpec::Function(ResponsesApiTool {
