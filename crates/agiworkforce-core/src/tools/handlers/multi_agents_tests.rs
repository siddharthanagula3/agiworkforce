...
use agiworkforce_protocol::protocol::FileSystemAccessMode;
use agiworkforce_protocol::protocol::FileSystemPath;
use agiworkforce_protocol::protocol::FileSystemSandboxEntry;
use agiworkforce_protocol::protocol::FileSystemSandboxPolicy;
use agiworkforce_protocol::protocol::InitialHistory;
use agiworkforce_protocol::protocol::InterAgentCommunication;
use agiworkforce_protocol::protocol::NetworkSandboxPolicy;
...
async fn install_role_with_model_override(turn: &mut TurnContext) -> String {
    ...
    tokio::fs::create_dir_all(&turn.config.agiworkforce_home)
        .await
...
async fn resume_agent_restores_closed_agent_and_accepts_send_input() {
    ...
    let thread = manager
        .resume_thread_with_history(
            ...
            AuthManager::from_auth_for_testing(AgiworkforceAuth::from_api_key("dummy")),
...
async fn build_agent_spawn_config_uses_turn_context_values() {
    ...
    turn.agiworkforce_linux_sandbox_exe = Some(PathBuf::from("/bin/echo"));
    ...
    expected.agiworkforce_linux_sandbox_exe = turn.agiworkforce_linux_sandbox_exe.clone();
