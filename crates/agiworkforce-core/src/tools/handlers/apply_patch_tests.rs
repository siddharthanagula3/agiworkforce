use super::*;
use agiworkforce_apply_patch::MaybeApplyPatchVerified;
...
async fn invocation_for_payload(payload: ToolPayload) -> ToolInvocation {
    ...
    ToolInvocation {
        ...
        tool_name: agiworkforce_tools::ToolName::plain("apply_patch"),
...
*** End Patch"#;
    ...
    let action = match agiworkforce_apply_patch::maybe_parse_apply_patch_verified(
        &argv,
        &cwd,
        LOCAL_FS.as_ref(),
        /*sandbox*/ None,
