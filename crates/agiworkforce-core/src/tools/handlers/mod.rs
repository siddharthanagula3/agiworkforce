...
use agiworkforce_sandboxing::policy_transforms::intersect_additional_permission_profiles as intersect_permission_profiles;
...
pub(crate) fn normalize_and_validate_additional_permissions(
    ...
    if uses_additional_permissions {
        ...
        let normalized = normalize_additional_permissions(additional_permissions.into())?;
        ...
        return Ok(Some(normalized.into()));
    }
