...
mod tests {
    ...
    async fn mcp_pre_tool_use_payload_uses_model_tool_name_and_raw_args() {
        ...
        assert_eq!(
            McpHandler.pre_tool_use_payload(&ToolInvocation {
                ...
                tool_name: agiworkforce_tools::ToolName::namespaced("mcp__memory__", "create_entities"),
    ...
    async fn mcp_post_tool_use_payload_uses_model_tool_name_args_and_result() {
        ...
        let output = McpToolOutput {
            result: agiworkforce_protocol::mcp::CallToolResult {
                content: vec![json!({
                    "type": "text",
                    "text": "notes"
                })],
        ...
        let invocation = ToolInvocation {
            ...
            tool_name: agiworkforce_tools::ToolName::namespaced("mcp__filesystem__", "read_file"),
            source: ToolCallSource::Direct,
            payload,
        };
        assert_eq!(
