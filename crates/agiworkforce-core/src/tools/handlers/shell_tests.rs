...
use agiworkforce_shell_command::powershell::try_find_powershell_executable_blocking;
use agiworkforce_shell_command::powershell::try_find_pwsh_executable_blocking;
use serde_json::json;
...
async fn shell_pre_tool_use_payload_uses_joined_command() {
    let payload = ToolPayload::LocalShell {
        params: agiworkforce_protocol::models::ShellToolCallParams {
            command: vec![
                "bash".to_string(),
                "-lc".to_string(),
                "printf hi".to_string(),
...
async fn shell_command_pre_tool_use_payload_uses_raw_command() {
    ...
    assert_eq!(
        handler.pre_tool_use_payload(&ToolInvocation {
            ...
            tool_name: agiworkforce_tools::ToolName::plain("shell_command"),
            source: crate::tools::context::ToolCallSource::Direct,
            payload,
        }),
        Some(crate::tools::registry::PreToolUsePayload {
