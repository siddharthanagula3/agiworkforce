...
use agiworkforce_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use agiworkforce_tools::TOOL_SEARCH_TOOL_NAME;
use agiworkforce_tools::coalesce_loadable_tool_specs;
...
mod tests {
    ...
    use agiworkforce_tools::ResponsesApiNamespace;
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        ...
        assert_eq!(
            ...
            vec![
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    ...
                    tools: vec![
                        ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                            ...
                            parameters: agiworkforce_tools::JsonSchema::object(
                                Default::default(),
                                /*required*/ None,
                                Some(false.into()),
                            ),
                ...
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    name: "agiworkforce_app".to_string(),
                    description: "Tools in the agiworkforce_app namespace.".to_string(),
                    tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                        ...
                        parameters: agiworkforce_tools::JsonSchema::object(
                            std::collections::BTreeMap::from([(
                                "mode".to_string(),
                                agiworkforce_tools::JsonSchema::string(/*description*/ None),
                            )]),
