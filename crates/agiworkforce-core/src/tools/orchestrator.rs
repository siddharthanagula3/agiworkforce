...
use agiworkforce_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let attempt_with_network_approval = SandboxAttempt {
            ...
            agiworkforce_linux_sandbox_exe: attempt.agiworkforce_linux_sandbox_exe,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            agiworkforce_linux_sandbox_exe: turn_ctx.agiworkforce_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
        ...
        match first_result {
            ...
            Err(ToolError::Agiworkforce(AgiworkforceErr::Sandbox(SandboxErr::Denied {
                output,
    ...
    async fn request_approval<Rq, Out, T>(
        ...
        otel: &agiworkforce_otel::SessionTelemetry,
            ...
            && let Some(permission_request) = tool.permission_request_payload(req)
        {
            ...
            .await
            {
                ...
                Some(PermissionRequestDecision::Deny { message }) => {
                    ...
                    return Err(ToolError::Rejected(message.unwrap_or_else(|| "Permission denied".to_string())));
                }
                None => {}
            }
        }
