...
impl CodeModeExecuteHandler {
    async fn execute(
        ...
        let args =
            agiworkforce_code_mode::parse_exec_source(&code).map_err(FunctionCallError::RespondToModel)?;
        ...
        let response = exec
            ...
            .services
            .code_mode_service
            .execute(agiworkforce_code_mode::ExecuteRequest {
        ...
        if !matches!(response, agiworkforce_code_mode::RuntimeResponse::Yielded { .. }) {
