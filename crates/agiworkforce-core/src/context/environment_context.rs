...
impl ContextualUserFragment for EnvironmentContext {
    ...
    const START_MARKER: &'static str = agiworkforce_protocol::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;
    const END_MARKER: &'static str = agiworkforce_protocol::protocol::ENVIRONMENT_CONTEXT_CLOSE_TAG;
