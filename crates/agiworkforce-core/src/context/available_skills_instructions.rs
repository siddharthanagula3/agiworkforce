use agiworkforce_core_skills::AvailableSkills;
use agiworkforce_core_skills::render_available_skills_body;
use agiworkforce_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
use agiworkforce_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
