...
const GUARDIAN_PREFERRED_MODEL: &str = "agiworkforce-auto-review";
...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: agiworkforce_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: agiworkforce_protocol::protocol::GuardianUserAuthorization,
