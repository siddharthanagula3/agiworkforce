...
use agiworkforce_analytics::GuardianReviewedAction;
use agiworkforce_protocol::approvals::GuardianAssessmentAction;
use agiworkforce_protocol::approvals::GuardianCommandSource;
...
fn command_assessment_action(
    ...
    GuardianAssessmentAction::Command {
        source,
        command: agiworkforce_shell_command::parse_command::shlex_join(command),
        cwd: cwd.clone(),
    }
}
