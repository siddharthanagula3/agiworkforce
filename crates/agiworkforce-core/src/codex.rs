...
use agiworkforce_hooks::HookEventAfterAgent;
use agiworkforce_hooks::HookPayload;
use agiworkforce_hooks::HookResult;
...
use agiworkforce_protocol::approvals::ExecApprovalRequestSkillMetadata;
...
use agiworkforce_utils_stream_parser::AssistantTextChunk;
use agiworkforce_utils_stream_parser::AssistantTextStreamParser;
...
use agiworkforce_otel::metrics::names::THREAD_STARTED_METRIC;
...
pub(crate) struct TurnContext {
    ...
    pub(crate) agiworkforce_linux_sandbox_exe: Option<PathBuf>,
...
impl SessionConfiguration {
    pub(crate) fn agiworkforce_home(&self) -> &PathBuf {
...
impl Session {
    ...
    pub(crate) async fn agiworkforce_home(&self) -> PathBuf {
    ...
    async fn new(
        ...
        let config_path = config.agiworkforce_home.join(CONFIG_TOML_FILE);
        ...
        let auth_env_telemetry = collect_auth_env_telemetry(
            &session_configuration.provider,
            auth_manager.agiworkforce_api_key_env_enabled(),
        );
        ...
        let session_start_source = match &initial_history {
            InitialHistory::Resumed(_) => agiworkforce_hooks::SessionStartSource::Resume,
            InitialHistory::New | InitialHistory::Forked(_) => {
                agiworkforce_hooks::SessionStartSource::Startup
            }
        };
        ...
        let (
            ...
            match state.session_configuration.clone().apply(&updates) {
                Ok(next) => {
                    ...
                    let agiworkforce_home = next.agiworkforce_home.clone();
    ...
    pub async fn request_mcp_server_elicitation(
        ...
        let id = match request_id {
            rmcp::model::NumberOrString::String(value) => {
                agiworkforce_protocol::mcp::RequestId::String(value.to_string())
            }
    ...
    async fn refresh_mcp_servers_inner(
        ...
        let sandbox_state = SandboxState {
            ...
            agiworkforce_linux_sandbox_exe: turn_context.agiworkforce_linux_sandbox_exe.clone(),
...
mod handlers {
    ...
    use agiworkforce_protocol::protocol::ReviewRequest;
    use agiworkforce_protocol::protocol::RolloutItem;
    use agiworkforce_protocol::protocol::SkillsListEntry;
    ...
    use agiworkforce_protocol::config_types::Settings;
    use agiworkforce_protocol::dynamic_tools::DynamicToolResponse;
    use agiworkforce_protocol::mcp::RequestId as ProtocolRequestId;
    use agiworkforce_protocol::user_input::UserInput;
    ...
    pub async fn resolve_elicitation(
        ...
        decision: agiworkforce_protocol::approvals::ElicitationAction,
    ...
    pub async fn drop_memories(sess: &Arc<Session>, config: &Arc<Config>, sub_id: String) {
        ...
        let memory_root = crate::memories::memory_root(&config.agiworkforce_home);
    ...
    ///
    /// This appends the name to `AGIWORKFORCE_HOME/sessions_index.jsonl` via `session_index::append_thread_name` for the
    ...
    pub async fn set_thread_name(sess: &Arc<Session>, sub_id: String, name: String) {
        ...
        let agiworkforce_home = sess.agiworkforce_home().await;
        if let Err(e) =
            session_index::append_thread_name(&agiworkforce_home, sess.conversation_id, &name).await
        {
            let event = Event {
                id: sub_id,
                msg: EventMsg::Error(ErrorEvent {
...
async fn spawn_review_thread(
    ...
    let review_turn_context = TurnContext {
        ...
        final_output_json_schema: None,
        agiworkforce_linux_sandbox_exe: parent_turn_context.agiworkforce_linux_sandbox_exe.clone(),
        tool_call_gate: Arc::new(ReadinessFlag::new()),
        ...
        .await
        {
            Ok(sampling_request_output) => {
                ...
                if !needs_follow_up {
                    ...
                    .to_string();
                    let stop_request = agiworkforce_hooks::StopRequest {
...
fn agent_message_text(item: &agiworkforce_protocol::items::AgentMessageItem) -> String {
    item.content
        .iter()
...
async fn emit_agent_message_in_plan_mode(
    sess: &Session,
    turn_context: &TurnContext,
    agent_message: agiworkforce_protocol::items::AgentMessageItem,
    state: &mut PlanModeStreamState,
) {
        ...
        .contains(&agent_message_id)
    {
        let start_item = state
            ...
            .unwrap_or_else(|| {
                TurnItem::AgentMessage(agiworkforce_protocol::items::AgentMessageItem {
