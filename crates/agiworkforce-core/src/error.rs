...
impl CodexErr {
    ...
    pub fn to_agiworkforce_protocol_error(&self) -> AgiWorkforceErrorInfo {
        match self {
            CodexErr::ContextWindowExceeded => AgiWorkforceErrorInfo::ContextWindowExceeded,
            CodexErr::UsageLimitReached(_)
            | CodexErr::QuotaExceeded
            | CodexErr::UsageNotIncluded => AgiWorkforceErrorInfo::UsageLimitExceeded,
            CodexErr::ServerOverloaded => AgiWorkforceErrorInfo::ServerOverloaded,
            CodexErr::RetryLimit(_) => AgiWorkforceErrorInfo::ResponseTooManyFailedAttempts {
            ...
            CodexErr::SessionConfiguredNotFirstEvent
            | CodexErr::InternalServerError
            | CodexErr::InternalAgentDied => AgiWorkforceErrorInfo::InternalServerError,
            CodexErr::UnsupportedOperation(_)
            | CodexErr::ThreadNotFound(_)
            | CodexErr::AgentLimitReached { .. } => AgiWorkforceErrorInfo::BadRequest,
            CodexErr::Sandbox(_) => AgiWorkforceErrorInfo::SandboxError,
