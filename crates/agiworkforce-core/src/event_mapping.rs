...
use agiworkforce_protocol::models::is_image_close_tag_text;
use agiworkforce_protocol::models::is_image_open_tag_text;
use agiworkforce_protocol::models::is_local_image_close_tag_text;
use agiworkforce_protocol::models::is_local_image_open_tag_text;
use agiworkforce_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
use agiworkforce_protocol::protocol::REALTIME_CONVERSATION_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            agiworkforce_protocol::items::ImageGenerationItem {
                id: id.clone(),
                status: status.clone(),
