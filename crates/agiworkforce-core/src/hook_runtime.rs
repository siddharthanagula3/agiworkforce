...
use agiworkforce_analytics::HookRunFact;
use agiworkforce_analytics::build_track_events_context;
use agiworkforce_hooks::PermissionRequestDecision;
use agiworkforce_hooks::PermissionRequestOutcome;
use agiworkforce_hooks::PermissionRequestRequest;
use agiworkforce_hooks::PostToolUseOutcome;
use agiworkforce_hooks::PostToolUseRequest;
use agiworkforce_hooks::PreToolUseOutcome;
use agiworkforce_hooks::PreToolUseRequest;
use agiworkforce_hooks::SessionStartOutcome;
use agiworkforce_hooks::UserPromptSubmitOutcome;
use agiworkforce_hooks::UserPromptSubmitRequest;
use agiworkforce_otel::HOOK_RUN_DURATION_METRIC;
use agiworkforce_otel::HOOK_RUN_METRIC;
...
use agiworkforce_protocol::protocol::HookStartedEvent;
...
pub(crate) async fn run_pending_session_start_hooks(
    ...
    let request = agiworkforce_hooks::SessionStartRequest {
...
fn hook_run_analytics_payload(
    ...
    completed: &HookCompletedEvent,
) -> (agiworkforce_analytics::TrackEventsContext, HookRunFact) {
    (
...
mod tests {
    ...
    use agiworkforce_protocol::protocol::HookEventName;
    use agiworkforce_protocol::protocol::HookExecutionMode;
