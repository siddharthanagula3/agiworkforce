...
pub(crate) async fn maybe_emit_implicit_skill_invocation(
    ...
    let skill_scope = match invocation.skill_scope {
        agiworkforce_protocol::protocol::SkillScope::User => "user",
        agiworkforce_protocol::protocol::SkillScope::Repo => "repo",
        agiworkforce_protocol::protocol::SkillScope::System => "system",
        agiworkforce_protocol::protocol::SkillScope::Admin => "admin",
    };
