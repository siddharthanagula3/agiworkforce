...
/// `agiworkforce_feedback::AgiworkforceFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// ```rust
/// agiworkforce_core::feedback_tags!(model = "gpt-5", cached = true);
/// agiworkforce_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
