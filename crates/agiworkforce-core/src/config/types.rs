...
pub use agiworkforce_protocol::config_types::ModeKind;
pub use agiworkforce_protocol::config_types::Personality;
pub use agiworkforce_protocol::config_types::ServiceTier;
...
pub struct Tui {
    ...
    /// Use `/theme` in the TUI or see `$AGIWORKFORCE_HOME/themes` for custom themes.
    #[serde(default)]
...
impl From<SandboxWorkspaceWrite> for agiworkforce_app_server_protocol::SandboxSettings {
