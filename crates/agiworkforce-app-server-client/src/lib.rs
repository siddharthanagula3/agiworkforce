...
//!
//! This crate wraps [`agiworkforce_app_server::in_process`] behind a single async API
...
//! [`InProcessClientHandle`](agiworkforce_app_server::in_process::InProcessClientHandle),
...
/// - [`agiworkforce_app_server::in_process::InProcessClientHandle`], which speaks to
...
mod tests {
    ...
    async fn typed_request_reports_json_rpc_errors() {
        ...
        let err = client
            .request_typed::<ConfigRequirementsReadResponse>(ClientRequest::ThreadRead {
                ...
                params: agiworkforce_app_server_protocol::ThreadReadParams {
    ...
    async fn threads_started_via_app_server_are_visible_through_typed_requests() {
        ...
        let response: ThreadStartResponse = client
            ...
            .expect("thread/start should succeed");
        let read = client
            .request_typed::<agiworkforce_app_server_protocol::ThreadReadResponse>(
