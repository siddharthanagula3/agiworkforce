...
pub struct ExecApprovalElicitRequestParams {
    ...
    pub agiworkforce_command: Vec<String>,
    pub agiworkforce_cwd: PathBuf,
    pub agiworkforce_parsed_cmd: Vec<ParsedCommand>,
}
...
pub(crate) async fn handle_exec_approval_request(
    ...
    call_id: String,
    approval_id: String,
    agiworkforce_parsed_cmd: Vec<ParsedCommand>,
    thread_id: ThreadId,
) {
    let escaped_command =
