...
//! `EscalateRequest` over the inherited `AGIWORKFORCE_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `AGIWORKFORCE_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use agiworkforce_protocol::approvals::EscalationPermissions;
pub use agiworkforce_protocol::approvals::ResolvedPermissionProfile;
