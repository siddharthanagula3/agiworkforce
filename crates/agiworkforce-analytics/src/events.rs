...
use agiworkforce_protocol::protocol::GuardianAssessmentOutcome;
use agiworkforce_protocol::protocol::GuardianCommandSource;
use agiworkforce_protocol::protocol::GuardianRiskLevel;
use agiworkforce_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(AgiworkforceAppMentionedEventRequest),
    AppUsed(AgiworkforceAppUsedEventRequest),
    HookRun(AgiworkforceHookRunEventRequest),
    Compaction(Box<AgiworkforceCompactionEventRequest>),
    TurnEvent(Box<AgiworkforceTurnEventRequest>),
    TurnSteer(AgiworkforceTurnSteerEventRequest),
    PluginUsed(AgiworkforcePluginUsedEventRequest),
    PluginInstalled(AgiworkforcePluginEventRequest),
    PluginUninstalled(AgiworkforcePluginEventRequest),
    PluginEnabled(AgiworkforcePluginEventRequest),
    PluginDisabled(AgiworkforcePluginEventRequest),
}
...
pub(crate) struct AgiworkforceAppServerClientMetadata {
...
#[derive(Clone, Serialize)]
pub(crate) struct AgiworkforceRuntimeMetadata {
    pub(crate) agiworkforce_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: AgiworkforceAppServerClientMetadata,
    pub(crate) runtime: AgiworkforceRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Agiworkforce turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct AgiworkforceAppMetadata {
...
#[derive(Serialize)]
pub(crate) struct AgiworkforceAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgiworkforceAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AgiworkforceAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgiworkforceAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AgiworkforceHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AgiworkforceHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgiworkforceHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct AgiworkforceCompactionEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct AgiworkforceCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgiworkforceCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct AgiworkforceTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<AgiworkforceErrorInfo>,
...
#[derive(Serialize)]
pub(crate) struct AgiworkforceTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgiworkforceTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct AgiworkforceTurnSteerEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct AgiworkforceTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgiworkforceTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct AgiworkforcePluginMetadata {
...
#[derive(Serialize)]
pub(crate) struct AgiworkforcePluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: AgiworkforcePluginMetadata,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
}
...
#[derive(Serialize)]
pub(crate) struct AgiworkforcePluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgiworkforcePluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct AgiworkforcePluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgiworkforcePluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "agiworkforce_plugin_installed",
        PluginState::Uninstalled => "agiworkforce_plugin_uninstalled",
        PluginState::Enabled => "agiworkforce_plugin_enabled",
        PluginState::Disabled => "agiworkforce_plugin_disabled",
    }
}

pub(crate) fn agiworkforce_app_metadata(
    tracking: &TrackEventsContext,
    app: AppInvocation,
) -> AgiworkforceAppMetadata {
    AgiworkforceAppMetadata {
...
pub(crate) fn agiworkforce_plugin_metadata(plugin: PluginTelemetryMetadata) -> AgiworkforcePluginMetadata {
    let capability_summary = plugin.capability_summary;
    AgiworkforcePluginMetadata {
...
pub(crate) fn agiworkforce_compaction_event_params(
    input: AgiworkforceCompactionEvent,
    app_server_client: AgiworkforceAppServerClientMetadata,
    runtime: AgiworkforceRuntimeMetadata,
    thread_source: Option<&'static str>,
    subagent_source: Option<String>,
    parent_thread_id: Option<String>,
) -> AgiworkforceCompactionEventParams {
    AgiworkforceCompactionEventParams {
...
pub(crate) fn agiworkforce_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> AgiworkforcePluginUsedMetadata {
    AgiworkforcePluginUsedMetadata {
        plugin: agiworkforce_plugin_metadata(plugin),
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
    }
...
pub(crate) fn agiworkforce_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> AgiworkforceHookRunMetadata {
    AgiworkforceHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
...
pub(crate) fn current_runtime_metadata() -> AgiworkforceRuntimeMetadata {
    let os_info = os_info::get();
    AgiworkforceRuntimeMetadata {
        agiworkforce_rs_version: env!("CARGO_PKG_VERSION").to_string(),
