/**
 * Complete script to update Stripe Hobby plan and sync with Supabase
 * Run with: STRIPE_SECRET_KEY=your_key SUPABASE_URL=your_url SUPABASE_SERVICE_KEY=your_key node scripts/update-stripe-hobby-complete.js
 */
