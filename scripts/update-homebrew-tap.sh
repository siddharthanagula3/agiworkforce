...
#     plus the SHA256SUMS / SHA256SUMS.sigstore.json pair published by release-cli.yml
#   - `cosign` is installed (https://docs.sigstore.dev/cosign/system_config/installation/)
