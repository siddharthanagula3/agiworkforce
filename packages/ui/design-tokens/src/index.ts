...
export const agiChatCssVars = {
  light: {
    ...
    '--chat-loading-placeholder': agiPalette.light.surface.hover,
    '--chat-loading-indicator': agiPalette.light.text.muted,
  ...
  dark: {
    ...
    '--chat-loading-placeholder': agiPalette.dark.surface.hover,
    '--chat-loading-indicator': agiPalette.dark.text.muted,
