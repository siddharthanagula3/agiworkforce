 ...
 *
 * Kept in step with the copy in @agiworkforce/unified-chat: this package sits
 * below that one and cannot import from it, and a settings dialog that says
 * "Failed to fetch" is the same defect wherever it renders.
 *
