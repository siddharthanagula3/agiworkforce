...
interface MenubarTriggerProps extends React.ComponentPropsWithoutRef<
...
interface MenubarSubTriggerProps extends React.ComponentPropsWithoutRef<
...
interface MenubarSubContentProps extends React.ComponentPropsWithoutRef<
...
function MenubarSubContent({ className, ref, ...props }: MenubarSubContentProps) {
  return (
    <MenubarPrimitive.SubContent
      ref={ref}
      className={cn(
        'z-[var(--z-popover,350)] min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
        className,
      )}
      {...props}
    />
...
interface MenubarContentProps extends React.ComponentPropsWithoutRef<
  ...
  return (
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          'z-[var(--z-popover,350)] min-w-[12rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
          className,
        )}
        {...props}
      />
...
function MenubarItem({ className, inset, ref, ...props }: MenubarItemProps) {
  return (
...
interface MenubarCheckboxItemProps extends React.ComponentPropsWithoutRef<
...
interface MenubarRadioItemProps extends React.ComponentPropsWithoutRef<
...
interface MenubarSeparatorProps extends React.ComponentPropsWithoutRef<
