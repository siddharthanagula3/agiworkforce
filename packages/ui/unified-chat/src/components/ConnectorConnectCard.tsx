            ...
            <div className="space-y-1">
              ...
              <ul className="flex flex-wrap gap-1" aria-label="Requested permissions">
                {visibleScopes.map((scope) => (
                  <li
                    key={scope}
                    className="max-w-full truncate rounded-md bg-muted px-1.5 py-0.5 font-mono text-caption text-muted-foreground"
                    title={scope}
                  >
                    {scope}
                  </li>
                ...
                {hiddenScopeCount > 0 ? (
                  <li className="rounded-md px-1.5 py-0.5 text-caption text-muted-foreground">
