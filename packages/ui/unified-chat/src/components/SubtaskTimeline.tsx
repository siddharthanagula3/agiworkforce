      ...
      <div className={cn('min-w-0 flex-1', isLast ? 'pb-0' : 'pb-4')}>
        ...
        <AnimatePresence initial={false}>
          {expanded && step.output && (
            ...
            >
              <pre className="mt-2 overflow-x-auto rounded-compact border border-white/10 bg-card/60 px-3 py-2 font-mono text-caption leading-relaxed text-muted-foreground whitespace-pre-wrap">
                {step.output}
              </pre>
            </motion.div>
          )}
