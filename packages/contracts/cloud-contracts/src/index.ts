 ...
 *
 * Canonical managed-cloud wire schemas, paths, stream deltas, and typed HTTP
 * clients shared by Web, Desktop, Mobile, and the Services compatibility facade.
 *
...
export * from './message-metadata-projection';
