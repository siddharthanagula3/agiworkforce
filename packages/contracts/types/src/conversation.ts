...
export interface ArtifactBase {
  ...
  content: string;
  language?: string;
  /** Current durable version when the backing runtime supports versioning. */
  version?: number;
  /** ISO timestamp from the canonical artifact record. */
  createdAt?: string;
  /** ISO timestamp of the current artifact version/update. */
  updatedAt?: string;
  /** Durable source conversation reference. */
  conversationId?: string;
  /** Durable source message reference used to restore inline artifacts. */
  messageId?: string;
