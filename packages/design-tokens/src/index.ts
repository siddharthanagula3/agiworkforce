...
export const agiChatCssVars = {
  light: {
    ...
    '--chat-accent-primary': agiPalette.light.accent.primary,
    '--chat-accent-secondary': agiPalette.light.accent.secondary,
  ...
  dark: {
    ...
    '--chat-accent-primary': agiPalette.dark.accent.primary,
    '--chat-accent-secondary': agiPalette.dark.accent.secondary,
