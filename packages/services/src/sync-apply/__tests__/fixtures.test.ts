 ...
 * ../../cloud-contracts/__tests__/sync.test.ts; this file additionally proves
...
import { applyArtifactDeltas, wireToCloudArtifact, type CloudArtifact } from '../../artifact-sync';
import {
  ConversationWireDeltaSchema,
  MessageWireDeltaSchema,
  ArtifactWireDeltaSchema,
} from '../../cloud-contracts/sync';
