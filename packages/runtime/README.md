...
`@agiworkforce/runtime` owns shared TypeScript runtime primitives that can be used across AGI Workforce surfaces without importing app code.
...
- `pnpm --filter @agiworkforce/runtime typecheck`
- `pnpm --filter @agiworkforce/runtime test`
- `pnpm --filter @agiworkforce/runtime build`
