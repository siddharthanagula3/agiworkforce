...
export const DEFAULT_SETTINGS_SECTIONS: ReadonlyArray<SettingsSection> = [
  ...
  },
  {
    ...
    render: () => (
      <SectionPlaceholder
        title="Connectors"
        body="MCP servers, OAuth integrations, and local data sources. Cloud-only connectors are waitlist-gated until Cloud Managed opens."
      />
    ),
  },
  {
  ...
  },
  {
    ...
    render: () => (
      <SectionPlaceholder
        title="Speech"
        body="Voice input language and dictation behavior. Local-mode voice runs entirely on-device; Cloud Managed voice (waitlist) adds higher-quality models."
      />
    ),
  },
];
