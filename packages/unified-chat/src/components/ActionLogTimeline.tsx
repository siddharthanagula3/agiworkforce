// packages/unified-chat/src/components/ActionLogTimeline.tsx
...
import type { ActionLogEntry, ActionLogEntryType, ActionLogStatus } from '../stores/agentLoopStore';
...
export function ActionLogTimeline({ messageId, className }: ActionLogTimelineProps) {
  const entries = useAgentLoopStore(selectActionLog(messageId));
