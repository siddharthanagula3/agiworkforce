...
pub struct CompletionResult {
    ...
    /// The same reason decoded onto the engine's closed set, so a turn can be
    /// judged without matching one provider's spelling.
    pub stop: Option<agiworkforce_llm::GenerationStop>,
