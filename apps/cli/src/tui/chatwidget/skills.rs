...
use agiworkforce_core::connectors::connector_mention_slug;
use agiworkforce_core::mention_syntax::TOOL_MENTION_SIGIL;
use agiworkforce_core::skills::model::SkillDependencies;
use agiworkforce_core::skills::model::SkillInterface;
use agiworkforce_core::skills::model::SkillMetadata;
use agiworkforce_core::skills::model::SkillToolDependency;
