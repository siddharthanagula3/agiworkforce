//! Double-press quit shortcut state machine for `ChatWidget`.
//!
//! Ctrl+C and Ctrl+D both participate in a timed "press twice to quit" flow.
//! This module owns the state transitions so the logic can be reviewed in
//! isolation from the rest of the event-handling surface.
