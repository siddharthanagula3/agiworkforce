...
pub fn normalize_pasted_path(pasted: &str) -> Option<PathBuf> {
    ...
    // Possibly use typed-path: https://github.com/agiworkforce/agiworkforce/pull/2567/commits/3cc92b78e0a1f94e857cf4674d3a9db918ed352e
    //
