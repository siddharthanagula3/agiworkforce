...
use agiworkforce_app_server_protocol::McpElicitationEnumSchema;
use agiworkforce_app_server_protocol::McpElicitationPrimitiveSchema;
use agiworkforce_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
const APPROVAL_META_KIND_KEY: &str = "agiworkforce_approval_kind";
    ...
    fn tool_suggestion_meta_is_parsed_into_request_payload() {
        let request = McpServerElicitationFormRequest::from_event(
            ...
            form_request(
                ...
                empty_object_schema(),
                Some(serde_json::json!({
                    "agiworkforce_approval_kind": "tool_suggestion",
                    "tool_type": "connector",
