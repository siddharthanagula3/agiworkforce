...
use agiworkforce_protocol::mcp::RequestId;
...
use agiworkforce_protocol::protocol::ElicitationAction;
    ...
    available_decisions
        ...
        .filter_map(|decision| match decision {
            ...
            ReviewDecision::Abort => Some(ApprovalOption {
                label: "No, and tell AGI Workforce what to do differently".to_string(),
...
mod tests {
    ...
    use agiworkforce_protocol::protocol::NetworkPolicyAmendment;
    ...
    fn network_exec_options_use_expected_labels_and_hide_execpolicy_amendment() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "Yes, and allow this host for this conversation".to_string(),
                "Yes, and allow this host in the future".to_string(),
                "No, and tell AGI Workforce what to do differently".to_string(),
            ]
        );
    }
    ...
    fn exec_history_cell_wraps_with_two_space_indent() {
        ...
        let rendered: Vec<String> = lines
            ...
            .collect();
        let expected = vec![
            "✔ You approved agiworkforce to run".to_string(),
