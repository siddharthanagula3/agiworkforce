...
yourself. Do not leave unfinished code markers in source files. After showing
the diff, add one optional learning exercise in the response, outside the code,
