...
import { CustomInstructionsDialog } from '@/features/custom-instructions';
...
import { MCPBundleBrowser } from '@/features/mcp/MCPBundleBrowser';
...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  const canAccessMediaLab = useMemo(
    () => canUseBillingPlanCapability(planName, 'image_generation'),
    [planName],
  );
