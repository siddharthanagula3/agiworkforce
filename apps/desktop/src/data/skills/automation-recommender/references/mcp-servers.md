...
MCP (Model Context Protocol) servers extend the assistant's capabilities by connecting to external tools and services.
...
**Debugging**: Use `agiworkforce --mcp-debug` to identify configuration issues.

## Documentation & Knowledge

### context7
**Best for**: Projects using popular libraries/SDKs where you want the assistant to code with up-to-date documentation
...
**Value**: The assistant fetches live documentation instead of relying on training data, reducing hallucinated APIs and outdated patterns.
...
**Value**: The assistant can interact with your running app, take screenshots, fill forms, and verify UI behavior.
...
**Value**: The assistant can query tables, manage auth, and interact with Supabase storage directly.
...
**Value**: The assistant can create issues, review PRs, check workflow runs, and manage releases.
...
**Value**: The assistant can investigate Sentry issues, find root causes, and suggest fixes.
...
**Value**: The assistant remembers project context, decisions, and patterns across conversations.
