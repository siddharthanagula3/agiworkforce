...
|--------|----------|--------------|
| **plugin-dev** | Building platform plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install platform automations from Anthropic's official repository or another shared marketplace
