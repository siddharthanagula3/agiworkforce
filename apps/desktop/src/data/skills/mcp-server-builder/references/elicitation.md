...
| Host | Status |
|---|---|
| AGI Workforce | ✅ since v2.1.76 (both `form` and `url` modes) |
| Desktop App | Unconfirmed — likely not yet or very recent |
| Web App | Unknown |
...
server.registerTool("delete_all", {
  ...
  // Fallback: return text asking the assistant to relay the question
