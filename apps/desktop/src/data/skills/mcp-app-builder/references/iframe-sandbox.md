...
MCP-app widgets run inside a sandboxed `<iframe>` in the host (the desktop app,
the web app).. The sandbox and CSP attributes lock down what the widget can do.
...
The iframe has its own console. In the desktop app, open DevTools (View → Toggle
