        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 text-xs rounded hover:bg-accent transition-colors text-muted-foreground shrink-0 ml-2"
                title="Copy code"
              >
                <Copy size={12} />
              </button>
          ...
          <div>
            <div className="bg-card rounded border border-border overflow-hidden">
              <div className="font-mono text-sm text-foreground max-h-96 overflow-y-auto">
                <table className="w-full">
                  <tbody>
                    {lines.map((line, idx) => (
                      <tr key={idx} className="hover:bg-accent">
                        <td className="select-none w-12 pr-4 text-right text-muted-foreground bg-background text-xs leading-6 py-0">
                          {idx + 1}
                        </td>
          ...
          {codeContent.diff && (
            <div>
              ...
              <div className="bg-card rounded border border-border p-3 font-mono text-xs text-foreground max-h-48 overflow-y-auto">
