  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-border overflow-hidden">
        <div className="bg-card px-4 py-2 text-xs font-medium text-muted-foreground border-b grid grid-cols-[1fr_auto_auto_auto] gap-4 items-center">
          <span>File</span>
          <span>Source</span>
          <span>Status</span>
          <span>Actions</span>
        ...
        <div className="divide-y divide-border">
          {INSTRUCTION_FILE_PATTERNS.map((p) => {
            ...
            return (
              <div
                key={p.pattern}
                className="px-4 py-3 grid grid-cols-[1fr_auto_auto_auto] gap-4 items-center hover:bg-card transition-colors"
              >
                {/* File name */}
