...
export const MODEL_PRESETS: Record<Provider, Array<{ value: string; label: string }>> = {
  ...
  google: [
    { value: 'gemini-2-flash', label: 'Gemini 2.0 Flash ⚡ (Ultra Fast & Cheap)' },
  ...
  mistral: [{ value: 'devstral-small', label: 'Devstral Small 2 ⚡ (Fast Coding)' }],
  moonshot: [
    {
...
export const MODEL_METADATA: Record<string, ModelMetadata> = {
  ...
  'gpt-5-mini': {
    ...
    quality: 'good',
    qualityTier: 'fast',
    bestFor: ['Quick Responses', 'Cost-Efficient Tasks', 'Well-Defined Tasks'],
    released: 'December 2025',
  },
  'gemini-2-flash': {
    id: 'gemini-2-flash',
    ...
    quality: 'good',
    qualityTier: 'fast',
    bestFor: ['Speed', 'High Volume', 'Cost Efficiency', 'Multimodal'],
    released: 'December 2025',
  },
  'deepseek-v3': {
    id: 'deepseek-v3',
  ...
  'devstral-small': {
    id: 'devstral-small',
    apiModelId: 'devstral-small-2501',
    ...
    quality: 'good',
    qualityTier: 'fast',
    bestFor: ['Coding', 'Fast Development', 'Cost Efficiency'],
    released: 'December 2025',
  },
  'grok-3-mini': {
    id: 'grok-3-mini',
