...
const TOOL_DISPLAY_MAP: Record<string, ToolDisplayInfo> = {
  ...
  browser_get_url: {
    displayName: 'Get URL',
    activeForm: 'Getting URL...',
    completedForm: 'Got URL',
    description: 'Get the current page URL',
    category: 'browser',
  },
  browser_get_title: {
    displayName: 'Get page title',
    activeForm: 'Getting title...',
    completedForm: 'Got title',
    description: 'Get the current page title',
    category: 'browser',
  },
  browser_go_back: {
    displayName: 'Go back',
    activeForm: 'Going back...',
    completedForm: 'Went back',
    description: 'Navigate to the previous page',
    category: 'browser',
  },
  browser_go_forward: {
    displayName: 'Go forward',
    activeForm: 'Going forward...',
    completedForm: 'Went forward',
    description: 'Navigate to the next page',
    category: 'browser',
  },
  browser_reload: {
    displayName: 'Reload page',
    activeForm: 'Reloading...',
    completedForm: 'Page reloaded',
  ...
  browser_evaluate: {
    ...
    completedForm: 'Script completed',
  ...
  browser_wait: {
    ...
    activeForm: 'Waiting...',
    completedForm: 'Element found',
    description: 'Wait for an element to appear on the page',
    category: 'browser',
  },
  browser_select: {
    displayName: 'Select option',
    activeForm: 'Selecting...',
    completedForm: 'Selected',
  ...
  browser_hover: {
    displayName: 'Hover',
    activeForm: 'Hovering...',
    completedForm: 'Hovered',
    description: 'Hover over an element',
    category: 'browser',
  },
  browser_input: {
    displayName: 'Fill input',
    activeForm: 'Filling input...',
    completedForm: 'Input filled',
    description: 'Fill in a form input field',
    category: 'browser',
  },
  ui_click: {
    displayName: 'Click',
