# Desktop Editor Feature

Status: Current
Owner: Desktop surface lead
Purpose: Own the Monaco editor wrapper used by Desktop coding surfaces.

## Boundaries

- Keep editor feature-specific UI and local composition in this folder.
