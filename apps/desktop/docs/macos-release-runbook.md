...
- If the Tauri updater key is exposed or lost, follow section 4 of `docs/security/security.md` before shipping; changing the key without the transition release described there strands every installed version.
