#[cfg(test)]
mod tests {
    use crate::core::agi::{ExecutionContext, Goal, Priority, ResourceState, ToolExecutionResult};
    use serde_json::json;
    ...
    fn test_context_memory_entry() {
        use crate::core::agi::ContextEntry;
    ...
    fn test_resource_usage_tracking() {
        let usage = crate::core::agi::ResourceUsage {
            cpu_percent: 15.5,
            memory_mb: 128,
            network_mb: 5.2,
        };
