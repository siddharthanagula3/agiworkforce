...
impl InstantDemo {
    ...
    /// Run demo for specified demo type
    pub async fn run_demo(
        ...
        // Record demo run
        self.record_demo_run(demo_id, user_id, &result)?;
    ...
    async fn run_inbox_manager_demo(&self) -> Result<DemoResult, DemoError> {
        ...
        Ok(DemoResult {
            demo_id: "inbox_manager".to_string(),
            demo_name: "Inbox Manager".to_string(),
    ...
    async fn run_data_entry_demo(&self) -> Result<DemoResult, DemoError> {
        ...
        Ok(DemoResult {
            demo_id: "invoice_processor".to_string(),
            demo_name: "Invoice Processor".to_string(),
    ...
    async fn run_code_review_demo(&self) -> Result<DemoResult, DemoError> {
        ...
        Ok(DemoResult {
            demo_id: "code_reviewer".to_string(),
            demo_name: "Code Reviewer".to_string(),
    ...
    async fn run_social_media_demo(&self) -> Result<DemoResult, DemoError> {
        ...
        Ok(DemoResult {
            demo_id: "social_media_monitor".to_string(),
            demo_name: "Social Media Monitor".to_string(),
    ...
    async fn run_meeting_scheduler_demo(&self) -> Result<DemoResult, DemoError> {
        ...
        Ok(DemoResult {
            demo_id: "meeting_scheduler".to_string(),
            demo_name: "Meeting Scheduler".to_string(),
    ...
    async fn run_expense_categorizer_demo(&self) -> Result<DemoResult, DemoError> {
        ...
        Ok(DemoResult {
            demo_id: "expense_categorizer".to_string(),
            demo_name: "Expense Categorizer".to_string(),
    ...
    async fn run_file_organizer_demo(&self) -> Result<DemoResult, DemoError> {
        ...
        Ok(DemoResult {
            demo_id: "file_organizer".to_string(),
            demo_name: "File Organizer".to_string(),
    ...
    async fn run_lead_qualifier_demo(&self) -> Result<DemoResult, DemoError> {
        ...
        Ok(DemoResult {
            demo_id: "lead_qualifier".to_string(),
            demo_name: "Lead Qualifier".to_string(),
    ...
    pub fn get_demo_statistics(&self, demo_id: Option<&str>) -> Result<DemoStatistics, DemoError> {
        ...
        Ok(DemoStatistics {
            ...
            most_popular_demo: "inbox_manager".to_string(), // Would query from DB
        })
    }
}
