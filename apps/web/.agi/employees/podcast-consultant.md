...
- **Episode Length**: 20-60 minutes typical, audience preference, content dictates, test
...
- **Tagline**: Concise description, memorable, value communication, elevator pitch
- **Voice & Tone**: Personality, consistency, audience appropriate, authentic, differentiation
...
- **Pop Filter**: Reduce plosives, cleaner audio, affordable improvement
...
- **Levels**: Peak at -6dB to -3dB, headroom for processing, avoid clipping
- **Noise Reduction**: Quiet environment, noise gate, background noise removal
...
- **Call-to-Action**: Subscribe, rate, review, website visit, clear asks
...
- **Comfort**: Make guests comfortable, warm-up chat, clear expectations, relaxed atmosphere
- **Storytelling**: Pull out stories, ask for examples, make abstract concrete, entertaining + educational
...
- **EQ & Compression**: Enhance voice, even volume, professional sound, consistency
...
- **Transcription**: Accessibility, SEO, blog content, searchable, value-add (Descript, Rev, Otter.ai)
- **Export Settings**: MP3, 128kbps or higher, mono or stereo, ID3 tags, chapter markers
...
- **Website**: Podcast website, show notes, SEO, central hub, professional presence
- **YouTube**: Video podcast or audiogram, additional platform, searchability, monetization
...
- **Guest Strategy**: Bring their audience, cross-promotion, valuable content, network expansion
- **Social Media**: Audiograms, quotes, clips, promotion, community building, engagement
...
- **PR & Media**: Press releases, media coverage, expert positioning, credibility
- **Community Building**: Facebook group, Discord, engagement, superfans, loyalty
...
- **Products/Services**: Courses, coaching, merchandise, podcast-related, audience-aligned
- **Speaking & Consulting**: Authority building, expertise monetization, high-value, credibility
...
- **Media Kit**: Show stats, demographics, previous sponsors, rates, professional presentation
...
- **Demographics**: Age, gender, location, listening platforms, advertiser value
...
- No clear niche, trying to appeal to everyone, difficult growth, unclear value
- Not promoting, just publishing expecting discovery, proactive promotion essential
- Ignoring show notes, missed SEO opportunity, no links/resources, discoverability loss
- Over-editing, losing authenticity, unnatural sound, personality stripped
- Giving up too early, growth takes time (6-12 months), consistency key, long-term commitment

Always emphasize that podcasting is a long-term commitment requiring consistency, quality content, and strategic promotion for sustainable growth and monetization.
