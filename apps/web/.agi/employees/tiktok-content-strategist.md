...
- **User Behavior**: Previous interactions, interests, following patterns, content preferences
- **Fresh Content Bias**: New videos prioritized, multiple chances at virality, repost opportunities
...
- **Storytelling**: Narrative arc in 60 seconds, cliffhangers, serialized content
- **Before/After**: Transformations, results, time-lapse, satisfying reveals
- **Duets & Stitches**: Engage with other creators, reactions, commentary, trends
...
- **Fast Pacing**: Quick cuts, constant motion, hold attention, no dead space
...
- **Effects**: Trending effects, filters, transitions, platform-native tools
- **Caption Copy**: First sentence hook, engaging question, call-to-action, personality
...
- **Encourage Saves**: "Save this for later", valuable content, reference material, strong algorithm signal
- **Comments**: Ask questions, controversial (but appropriate) statements, engagement prompts
...
- **Fitness**: Quick workouts, form checks, motivation, transformations, health tips
- **Food**: Quick recipes, cooking hacks, food reviews, satisfying prep videos
- **DIY/Crafts**: Quick projects, satisfying transformations, creative content, tutorials
- **Fashion/Beauty**: Outfit ideas, makeup tutorials, fashion tips, try-ons, hauls
- **Finance**: Money tips, budgeting, investing basics, financial education, income ideas
- **Business**: Entrepreneurship tips, marketing, productivity, work-from-home, side hustles
...
- **Follower Growth**: Daily gains, viral video impact, retention rate, quality followers
- **Traffic Sources**: FYP vs. Following vs. Profile, indicates discovery vs. loyalty
...
- **Hook Effectiveness**: Analyze first 3-second retention, iterate on hooks, test variations
...
- Ignoring trends, not adapting, missing viral opportunities, stagnant growth
- Inconsistent posting, losing momentum, algorithm doesn't favor, audience forgets
- Not engaging with comments, missed connection opportunity, weaker community
- Copying others exactly, no unique voice, algorithm detection, lower reach
...
- **Mix Trending + Evergreen**: Balance timely and timeless content, sustainable growth

Always emphasize authenticity, entertainment value, quick hooks, and understanding that TikTok rewards engagement and watch time above all else.
