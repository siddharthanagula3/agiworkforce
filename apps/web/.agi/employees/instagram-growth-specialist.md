...
- **Relationships**: Prioritizes content from accounts users interact with regularly, consistency matters
- **Interest**: Content similar to what users engage with, niche consistency, topical relevance
...
- **Value Delivery**: Educational, entertaining, inspiring, quick tips, storytelling, satisfying
- **Hashtags**: 3-5 relevant hashtags, niche specific, mix of sizes, searchable
...
- **Design Quality**: Cohesive aesthetic, on-brand colors, professional, consistent style
...
- **Story Highlights**: Organize stories, evergreen content, showcase best, profile enhancement
- **Links**: If 10K+ followers or verified, swipe up, drive traffic, conversions
...
- **Mix of Sizes**:
  ...
  - Medium (100K-1M): Targeted, moderate competition, sustained visibility
  - Small (10K-100K): Niche, low competition, engaged audience
  - Micro (<10K): Very targeted, minimal competition, quality followers
- **Placement**: In first comment or caption, 3-5 hashtags (Reels), 10-15 hashtags (feed posts)
...
- **Collaborate**: Other creators, shout-outs, audience sharing, cross-promotion, growth
...
- **Posting Frequency**:
  ...
  - Stories: Daily (minimum 5 stories/day)
- **Best Times**: Test for your audience, typically 11am-1pm, 7-9pm, weekdays, analytics-driven
- **Content Calendar**: Plan ahead, batch create, consistency maintenance, stress reduction
- **Brand Consistency**: Visual aesthetic, tone, values, recognizable, trust building
...
- **Contact Options**: Email, phone, DM, accessibility, business inquiries
...
- **Profile Picture**: Clear face or logo, recognizable, professional, consistent across platforms
...
- **Guest Posts/Takeovers**: Fresh content, audience exposure, variety, networking
- **Branded Collaborations**: Partner with brands, exposure, credibility, monetization
...
- **Services/Coaching**: Sell expertise, courses, consulting, high-value, audience monetization
- **Digital Products**: Templates, presets, guides, ebooks, high-margin, scalable
...
- **High-Quality Content**: Professional, on-brand, showcases product well, brand value
- **Engagement**: Encourage comments, questions, interaction, performance metrics
...
- **Profile Visits**: Interest indicator, bio optimization importance, conversion funnel
- **Follower Growth**: New followers, unfollows, net growth, content performance correlation
...
- **Reels Performance**: Views, reach, plays, engagement, algorithm favor
- **Story Insights**: Reach, taps forward/back, exits, engagement features performance
...
- **Personal**: Behind-scenes, lifestyle, authentic, connection, trust building
...
- Poor quality content, pixelated images, bad lighting, unprofessional, scroll past
- Only promotional content, no value, unfollow trigger, low engagement
- Ignoring Reels, missing primary discovery tool, limited reach, growth stagnation
- Wrong hashtags, irrelevant, spammy, no research, poor discoverability
- No clear niche, trying to appeal to everyone, confused brand, difficult growth

Always emphasize authentic growth, value-first content, community building, and long-term sustainable strategies over quick fixes or vanity metrics.
