...
- **Multi-Family**: Apartments (5+ units), student housing, senior housing, affordable housing
- **Hospitality**: Hotels, motels, resorts, bed & breakfasts, extended stay
- **Special Purpose**: Self-storage, car washes, gas stations, healthcare facilities, data centers
...
- **Triple Net (NNN)**: Tenant pays base rent + taxes + insurance + maintenance/repairs
...
- **Common Area Maintenance (CAM)**: Shared expenses, reconciliation, caps
- **Exclusive Use**: Retail tenants, preventing competition, radius restrictions
...
- **Financial Terms**: Rent rate, escalations, operating expenses, security deposit, personal guarantee
- **Lease Negotiation**: Rent concessions, free rent, TI allowance, early termination, flexibility
...
- **Debt Service Coverage Ratio (DSCR)**: NOI ÷ debt service, lender requirement (typically 1.25x minimum)
- **Price Per Square Foot**: Comparable analysis, market norms, property type variations
...
- **Triple Net**: Passive investment, tenant manages property, stable income, lower management
- **1031 Exchange**: Tax-deferred exchange, like-kind property, timeline requirements, tax strategy
...
- **Leases**: Review all leases, terms, obligations, renewal options, tenant improvements
...
- **Zoning**: Current zoning, permitted uses, conforming vs. non-conforming, expansion potential
- **Title Review**: Ownership, liens, easements, restrictions, encumbrances, clear title
...
- **Life Insurance Companies**: Low rates, stable properties, longer terms, lower leverage
...
- **Recourse**: Personal guarantee vs. non-recourse, credit/net worth requirements
...
- **Comparables**: Recent sales, lease rates, cap rates, price trends, market velocity
...
- **Leasing**: Marketing vacant space, tenant prospecting, lease negotiations, broker coordination
- **Asset Management**: Property performance, value enhancement, strategic planning, owner reporting
...
- **Costs**: Rent rate, operating expenses, build-out costs, total occupancy cost
- **Lease Terms**: Flexibility, renewal options, exclusive use, termination rights
...
- CPAs/tax advisors (tax implications, entity structuring, 1031 exchanges)
- Commercial property inspectors and engineers (due diligence, condition assessment)
- Environmental consultants (Phase I/II ESA, contamination assessment)

Commercial transactions are sophisticated, involve significant capital, and benefit greatly from experienced professional representation and advisors.
