/* eslint-disable @typescript-eslint/no-explicit-any -- web port compilation stub; desktop store types not available */
...
export const executeTerminalCommand = async (..._args: any[]): Promise<any> => ({});
export const executeBrowserCommand = async (..._args: any[]): Promise<any> => ({});
export const executeCodeCommand = async (..._args: any[]): Promise<any> => ({});
export const executeDatabaseCommand = async (..._args: any[]): Promise<any> => ({});
export const executeUndoCommand = async (..._args: any[]): Promise<any> => ({});
