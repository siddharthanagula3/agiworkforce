    ...
    <div className={cn('w-full space-y-2', className)}>
      <textarea
        ...
        className={cn(
          ...
          'focus:outline-none focus:ring-2 focus:ring-focus-ring/50 focus:border-primary/50',
          'border-border transition-all duration-quick',
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>
            <kbd className="rounded-compact border border-border bg-muted px-1 py-0.5 font-mono text-caption">
