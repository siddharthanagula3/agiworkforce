  ...
  return (
    <li>
      ...
      >
        ...
        {incomplete && (
          <span
            className="mt-0.5 flex shrink-0 items-center gap-1 rounded-compact bg-muted/60 px-1.5 py-0.5 text-caption font-medium text-muted-foreground"
    ...
    return (
      <div className="flex h-full min-h-0 flex-col" data-testid="research-reports-gallery-detail">
        <button
          ...
          className="flex shrink-0 items-center gap-1 border-b border-border/20 px-4 py-1.5 text-caption text-muted-foreground transition-colors hover:text-foreground"
        >
