/**
 * VIBE Keyboard Shortcuts Dialog
...
interface VibeKeyboardShortcutsDialogProps {
  ...
  shortcuts: VibeKeyboardShortcut[];
}

export function VibeKeyboardShortcutsDialog({
  open,
  onOpenChange,
  shortcuts,
  ...
  const groupedShortcuts = shortcuts.reduce(
    ...
    {} as Record<string, VibeKeyboardShortcut[]>,
  );
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <div className="flex items-center gap-2">
            ...
            <DialogTitle>VIBE Keyboard Shortcuts</DialogTitle>
          </div>
          <DialogDescription>
            Speed up your coding workflow with these keyboard shortcuts
          </DialogDescription>
        </DialogHeader>
