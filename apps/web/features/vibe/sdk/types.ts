/**
 * Core types from VibeSDK
 *
 * Copied and adapted from: https://github.com/nichochar/vibing-ai/blob/main/sdk/src/types.ts
 */
...
export type AgentEventMap = {
  ...
  generation: WsMessageOf<
    'generation_started' | 'generation_complete' | 'generation_stopped' | 'generation_resumed'
  >;
...
export type AgentConnection = {
  ...
  onAny: (
    cb: (event: keyof AgentEventMap, payload: AgentEventMap[keyof AgentEventMap]) => void,
  ) => () => void;
