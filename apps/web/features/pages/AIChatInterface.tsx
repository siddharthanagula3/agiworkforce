  ...
  const useCases = [
    {
      ...
      description: 'Handle FAQs, troubleshooting, account issues, and product questions instantly.',
    },
    {
    ...
    },
    {
      ...
      description: 'Support employees with HR questions, IT requests, and policy information.',
    },
    {
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mb-8 text-xl text-muted-foreground">
                Deploy AI chat agents that understand context, speak 100+ languages, and provide
