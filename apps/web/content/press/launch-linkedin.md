...
It is an AI assistant that runs entirely on your phone. No subscription. Works in airplane mode. Your conversations never leave your device.
...
The implication: a free, private AI assistant that works when your internet is spotty, in countries with data sovereignty concerns, in regulated industries where cloud AI is not an option, and on the 95%+ of Android devices that do not qualify for Gemini Intelligence.
...
**Transparent roadmap.** Cloud models, sync, and team features are coming. They are waitlist-gated for now. The local experience is free. It will stay free.
...
**What it is:** a free AI assistant for iOS and Android that runs entirely on your phone. No server call during a conversation. Works offline. DPDP compliant.
