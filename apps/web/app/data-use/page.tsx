      ...
      <main className="agi-shell">
        ...
        <section className="agi-section">
          ...
          <p className="agi-page-lede" style={{ marginTop: 0 }}>
            ...
            and the summary does not, you end up with two published answers and no way to tell which
            is current. So this page deliberately states no retention window, no recipient name and
            no commitment of its own. Every concrete fact above is a link into the policy that owns
            it. If you are editing this page and find yourself typing a number, link to the section
            instead.
          </p>
