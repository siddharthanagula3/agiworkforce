            ...
            <div className="agi-ds-sticky-flow">
              <Section id="s-00" labelledBy="agi-india-00-title" rule>
                <Stack gap="tight">
                  ...
                  <Prose>
                    ...
                    processing described here: it decides why and how your personal data is
                    processed. You are the <strong>Data Principal</strong>. AGI has no establishment
                    in India and no data centre in India; your data is hosted in the United States,
                    which section 06 explains.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-01" labelledBy="agi-india-01-title" rule ground="2">
                <Stack gap="loose">
                  <div>
                    ...
                    <Prose>
                      Most of this notice depends on which mode you run, because Local, BYOK and
                      Managed Cloud are separate trust boundaries and your data goes to genuinely
                      different places in each. Read this first.
                    </Prose>
                  </div>
              ...
              <Section id="s-02" labelledBy="agi-india-02-title" rule>
                <Stack gap="loose">
                  <div>
                    ...
                    <Prose>
                      The Act requires the purpose to be specific and the data to be limited to what
                      that purpose needs. Each row below is one purpose, not a category we might
                      later reuse.
                    </Prose>
                  </div>
                  <Ledger caption="Processing purposes" rows={PROCESSING} />
                  <Prose size="sm">
                    <strong>What we do not do with it.</strong> AGI does not train AGI-owned models
                    on your prompts, responses or files. We run no advertising, set no advertising
                    cookies, and do not sell or share personal data for cross-context behavioural
                    advertising.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-03" labelledBy="agi-india-03-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose size="sm">
                    ...
                    , with no email and no support ticket. Withdrawal stops the future processing
                    that depended on it; it does not undo processing that already lawfully happened,
                    and it does not delete your account. That is a separate request on the same
                    page.{' '}
                    <strong>
                      AGI is not registered with a Consent Manager under section 6(7), so consent is
                      given to us directly rather than through one.
                    </strong>
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-04" labelledBy="agi-india-04-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    . In summary: an identity provider holds your login, Stripe holds your payments,
                    our hosting and database vendors hold what you store in Managed Cloud, object
                    storage holds your files, and error/analytics vendors receive only what section
                    02 describes and only with your consent.
                  </Prose>
                  <Prose size="sm">
                    <strong>
                ...
                <Stack gap="loose">
                  <div>
                    ...
                    <Prose>
                      ...
                      retention is required by law. Every row below is a job or a mechanism that
                      exists in the product, and the ones we do not control are named as such. The
                      full schedule, including billing records, is section 05 of the{' '}
                      <Link href={CANONICAL_POLICY_ROUTES.privacy} className="agi-ds-link">
                        privacy policy
                      </Link>
                      .
              ...
              <Section id="s-06" labelledBy="agi-india-06-title" rule>
                <Stack gap="tight">
                  ...
                  <Prose>
                    ...
                    AGI does not offer data residency in India, so using this service means your
                    personal data leaves India. The Act permits transfer outside India except to
                    territories the Central Government restricts by notification; whether any
                    notification affects the United States is a question of the live notification
                    list on the date you read this, and we will not assert an answer to it here. If
                    you need Indian data residency, we do not have it, and you should not sign up
                    expecting it.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-07" labelledBy="agi-india-07-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose size="sm">
                    The Act also places duties on you: do not impersonate someone else when giving
                    your data, do not suppress material information when it is legally required, and
                    do not file false or frivolous grievances.
                  </Prose>
                </Stack>
              </Section>
                ...
                <Stack gap="loose">
                  ...
                  <Stack gap="tight">
                    ...
                    <Prose size="sm">
                      ...
                      with the subject line &ldquo;{CONTACT_SUBJECTS.dpdpGrievance}&rdquo;, or post
                      to {LEGAL_ENTITY}, {NOTICE_ADDRESS}. We aim to respond within{' '}
                  ...
                  <Prose size="sm">
                    Subject-line routing is used because this is the one mailbox proven to receive
                    mail; a dedicated grievance address is not provisioned, and we would rather
                    publish a working inbox than a dedicated one that bounces. If our response does
                    not resolve it, you may complain to the Data Protection Board of India.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-11" labelledBy="agi-india-11-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose>
                    This notice is published in English. The Act entitles you to it in any language
                    in the Eighth Schedule to the Constitution; translations are not yet published,
                    and that is an open item. The current version is always at this URL with the
