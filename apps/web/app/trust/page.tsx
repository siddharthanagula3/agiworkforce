                    ...
                    rows={[
                      {
                        label: '2026-09-23',
                        value:
                          'Re-measured after the two experiential Free model routes shipped on the caller-scoped connection and the model-attestation route shipped without a database dependency. The row-level-isolation count moved from 175 to 177 of 278 database-backed routes; the owner-connection remainder stays at 101 and the routes that touch no database move from 116 to 117.',
                      },
                      {
                        label: '2026-09-21',
                        value:
