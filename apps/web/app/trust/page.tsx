                    ...
                    rows={[
                      {
                        label: '2026-09-20',
                        value:
                          'Re-measured after the sign-in methods route, the legal hold preservation count, the soft-deleted resource purge and the client failure ingest shipped, and after connecting GitHub began checking the workspace policy, which makes that route read the database. The database-backed total moved from 267 to 271 and the owner-connection remainder from 95 to 99; the row-level-isolation count stays at 172. The number of hosted routes that touch no database ends the day where it began, at 115.',
                      },
                      {
                        label: '2026-09-20',
                        value:
                      ...
                      },
                      {
                        label: '2026-09-12',
                        value:
                          'Re-measured after four hosted routes shipped. The two live voice session routes, one to open a session and one to close it, read through the caller-scoped connection, so the row-level-isolation count moved from 114 to 116. A cron route that reconciles reported provider costs uses the owner connection, so that count moved from 87 to 88. An operator economics route touches no database, so the routes excluded from both sides moved from 87 to 88. The database-backed total moved from 201 to 204.',
                      },
                      {
                        label: '2026-09-08',
                        value:
                          'Re-measured again the same day, after route work that had not yet been counted and one cron route that returns quota held by a reservation whose turn is gone. The database-backed total moved from 199 to 201 and the owner-connection count from 85 to 87. The routes excluded from both sides moved from 88 to 87. The row-level-isolation count stays at 114.',
                      },
                      {
                        label: '2026-09-08',
                        value:
