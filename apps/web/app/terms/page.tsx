            ...
            <div className="agi-ds-sticky-flow">
              ...
              <Section id="s-01" labelledBy="agi-terms-s01-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    organisation, that organisation) and {LEGAL_ENTITY}, {LEGAL_ENTITY_DESCRIPTOR}.
              ...
              <Section id="s-02" labelledBy="agi-terms-s02-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    authorised to bind it. You must not use AGI if you are barred from doing so
                    under the laws of your country or the United States.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-03" labelledBy="agi-terms-s03-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    {LEGAL_ENTITY} grants you a non-exclusive, non-transferable, revocable licence
                    to install and use AGI on devices you own or control, and to access the hosted
                    service, subject to these terms. The software and the service are proprietary;
              ...
              <Section id="s-05" labelledBy="agi-terms-s05-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    material you submit remain yours, as does the output generated for you, to the
                  ...
                  <Prose>
                    ...
                    the rights to what you submit and for not submitting content you are
                    contractually or legally barred from disclosing.
                  </Prose>
                  <Prose>
                  ...
                  <Prose>
                    ...
                    them without restriction or obligation to you. You are not required to send
                    feedback.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-06" labelledBy="agi-terms-s06-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    default, but it may change, break, lose features, or be discontinued, and
                    capacity and model availability may vary. No service level agreement applies to
                    it during alpha; the targets published at{' '}
                    <Link href="/sla" className="agi-ds-link">
                      /sla
                    </Link>{' '}
                    are stated intentions for general availability, not commitments you can enforce
                    today. Do not build a production dependency on Managed Cloud without accepting
                    that. Local and BYOK modes run on your own device and your own provider account
                    respectively, and are not affected by this section.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-07" labelledBy="agi-terms-s07-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    AGI can execute code, act on accounts you connect, and run unattended on a
                    schedule. The{' '}
                    <Link href="/acceptable-use" className="agi-ds-link">
                      acceptable use policy
                    </Link>{' '}
                    sets out what you must not do with those capabilities, what your obligations are
                    when the agent acts on your behalf, and what we do about violations. It is part
                    of these terms and breaching it is a breach of this agreement.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-08" labelledBy="agi-terms-s08-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    professional advice. Do not rely on it for legal, medical, financial,
                    safety-critical, or other consequential decisions without independent
                    verification by a qualified human. Similar prompts may produce different output
                    for different users, and output is not guaranteed to be unique to you. You are
                    responsible for reviewing output before you act on it or ship it.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-09" labelledBy="agi-terms-s09-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    When you connect a third-party account, you authorise AGI to act with the
                    permissions you grant. Your use of that third party remains governed by your
                    agreement with them, and they may suspend or revoke your access independently of
                    us. We are not responsible for a third-party service&rsquo;s availability,
                    accuracy, security, or changes to its interfaces.
                  </Prose>
                  <Prose>
                    <strong>BYOK.</strong> When you bring your own API key for a provider such as
                    Anthropic, OpenAI or Google, your use of that provider is governed by{' '}
                    <em>their</em> terms, not ours. Provider billing and data handling are between
                    you and them; AGI does not process those payments and does not sit in the
                    request path.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-10" labelledBy="agi-terms-s10-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose>
                    Paid subscriptions are billed in advance through Stripe, our payment processor,
                    or the applicable app store, at the price and billing period shown at{' '}
                    <Link href="/pricing" className="agi-ds-link">
                      /pricing
                    </Link>{' '}
                    or in your order form when you subscribe. <strong>Auto-renewal:</strong>{' '}
                    subscriptions renew automatically at the end of each billing period until you
                    cancel. Cancelling stops the next renewal; access continues through the period
                    you have paid for, and the current period is not automatically refunded. Refund
                    terms are at{' '}
                  ...
                  <Prose>
                    ...
                    sales, use, VAT, GST and similar taxes, excluding taxes on our income. We may
                    change pricing with 30 days&rsquo; notice posted on{' '}
                    <Link href="/pricing" className="agi-ds-link">
                      /pricing
                    </Link>{' '}
                    and{' '}
                    ...
                    ; an existing annual subscription keeps its price through the end of its current
              ...
              <Section id="s-11" labelledBy="agi-terms-s11-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    We may suspend or restrict your access where you breach the acceptable use
                    policy, where payment fails and is not cured, where we are legally required to,
              ...
              <Section id="s-14" labelledBy="agi-terms-s14-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose>
                    If you believe content on our service infringes your copyright or other
                    ...
                    identification of the work, the material you say infringes it and where it is,
                    your contact details, a statement of good-faith belief that the use is
                    unauthorised, a statement that your notice is accurate and that you are
                    authorised to act, and your signature. We respond to complete notices, may
                    remove the material, and may terminate repeat infringers. You may submit a
                    counter-notice by the same route.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-15" labelledBy="agi-terms-s15-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    DEALING OR TRADE USAGE, TO THE MAXIMUM EXTENT PERMITTED BY LAW. We do not
                  ...
                  <Prose>
                    ...
                    law, our aggregate liability arising out of or relating to these terms or your
                    use of AGI is limited to the fees you paid us in the 12 months preceding the
                    claim, or 100 USD, whichever is greater. We are not liable for loss of profits,
                    revenue, data, goodwill, or for indirect, incidental, special, consequential, or
                    punitive damages, even if advised of the possibility. Nothing here excludes
                    liability that cannot lawfully be excluded, including for death or personal
                    injury caused by negligence, fraud, or fraudulent misrepresentation; where your
                    jurisdiction does not allow certain exclusions, they do not apply to you.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-16" labelledBy="agi-terms-s16-title" rule ground="2">
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    reasonable attorneys&rsquo; fees) arising from (a) your use or misuse of AGI,
                    (b) content you submit through the service, (c) your violation of these terms,
                    the acceptable use policy, or applicable law, or (d) your infringement of any
                    third-party right. We may assume the exclusive defence of any matter for which
                    you owe us indemnification, and you will cooperate with it.
                  </Prose>
                </Stack>
              </Section>
              ...
              <Section id="s-17" labelledBy="agi-terms-s17-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    may select a different governing law for cross-border transfer obligations, and
                    that selection prevails for those obligations.
                  </Prose>
                  <Prose>
                    <strong>Arbitration:</strong> any dispute arising out of or relating to these
                    terms or your use of AGI will be resolved by binding individual arbitration
                    administered by {ARBITRATION_FORUM}, seated in {VENUE}. You waive any right to a
                    jury trial or to participate in a class action. You may opt out of arbitration
                    ...
                    with the subject line &ldquo;{CONTACT_SUBJECTS.arbitrationOptOut}&rdquo;; opting
                    out does not affect any other part of these terms. If arbitration is unavailable
                    or the waiver is held unenforceable, disputes will be resolved in the state or
                    federal courts located in {VENUE}, and both parties consent to that
                    jurisdiction. Nothing prevents either party from seeking injunctive relief for
                    infringement or misuse of intellectual property, or from bringing an individual
              ...
              <Section id="s-19" labelledBy="agi-terms-s19-title" rule>
                <Stack gap="loose">
                  ...
                  <Prose>
                    ...
                    , which forms part of these terms. Where you contract with us as a business
                    customer and we process personal data on your behalf, the{' '}
