                  ...
                  <div className="flex animate-marquee items-center gap-20 md:gap-28">
                    {[...Array(2)].map((_, i) => (
                      <div key={i} className="flex shrink-0 items-center gap-20 md:gap-28">
                        ...
                        {/* Qwen (Alibaba) - text wordmark */}
                        <span
                          className="text-white/60 hover:text-white/90 transition-all font-semibold text-sm shrink-0 tracking-wide"
                          aria-label="Qwen"
                        >
                          Qwen
                        </span>
