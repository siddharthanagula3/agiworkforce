    ...
    <>
      ...
      <div className="flex min-h-screen flex-col bg-black text-white">
        ...
        <main className="flex-1 pt-24">
          ...
          {/* Provider Logo Bar — symbols only, infinite scroll */}
          <section className="border-y border-zinc-800/50 bg-zinc-950/50 py-12 overflow-hidden">
              ...
              <div className="flex animate-marquee items-center gap-20 md:gap-28">
                {[...Array(2)].map((_, i) => (
                  <div key={i} className="flex shrink-0 items-center gap-20 md:gap-28">
                    ...
                    <svg
                      viewBox="0 0 24 24"
                      className="h-8 w-8 shrink-0 fill-zinc-400 opacity-60 transition-opacity hover:opacity-100"
                      aria-label="OpenAI"
                    >
                    ...
                    <svg
                      viewBox="0 0 24 24"
                      className="h-8 w-8 shrink-0 fill-cyan-500 opacity-60 transition-opacity hover:opacity-100"
                      aria-label="DeepSeek"
                    >
                    ...
                    <svg
                      viewBox="0 0 24 24"
                      className="h-8 w-8 shrink-0 fill-blue-500 opacity-60 transition-opacity hover:opacity-100"
                      aria-label="Meta"
                    >
                    ...
                    >
                      ...
                      <circle cx="10" cy="7.5" r="0.8" fill="#0a0a0a" />
                      <circle cx="14" cy="7.5" r="0.8" fill="#0a0a0a" />
                    </svg>
                    {/* Groq */}
                    <svg
                      viewBox="0 0 24 24"
                      className="h-8 w-8 shrink-0 fill-purple-400 opacity-60 transition-opacity hover:opacity-100"
                      aria-label="Groq"
                    >
                    ...
                    <svg
                      viewBox="0 0 24 24"
                      className="h-8 w-8 shrink-0 fill-teal-400 opacity-60 transition-opacity hover:opacity-100"
                      aria-label="Perplexity"
                    >
                      <path d="M12 2L3 7v10l9 5 9-5V7l-9-5zm0 2.18l7 3.89v7.86l-7 3.89-7-3.89V8.07l7-3.89z" />
                      <path d="M12 8v8M8 10l4 2 4-2M8 14l4 2 4-2" />
                    </svg>
                    {/* Together */}
                    <svg
                      viewBox="0 0 24 24"
                      className="h-8 w-8 shrink-0 fill-blue-400 opacity-60 transition-opacity hover:opacity-100"
                      aria-label="Together"
                    >
