...
export default function DownloadError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="text-2xl font-bold text-white mb-3">Unable to Load Download Page</h1>
      <p className="text-zinc-400 max-w-sm mx-auto mb-2">
        An unexpected error occurred. Please try again or visit our releases page directly.
      </p>
