 ...
 * and has test coverage there. This page links to it rather than duplicating.
 */
...
export default function AccountSettingsPage() {
  ...
  // Compute a rough session row from what we know about the current user
...
/** Detect a rough device label from the browser's user agent. */
