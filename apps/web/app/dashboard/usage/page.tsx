            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-zinc-400 max-w-md mx-auto">
                  Your credits will be allocated when your subscription period starts. Once you
                  start using the desktop app, your usage will appear here.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <Card className="bg-zinc-900 border-zinc-800">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-zinc-500 mt-1">
                    {dailyPercentage}% used (resets daily)
                  </p>
                </CardContent>
              </Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-zinc-400">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Daily limits (30% of monthly) prevent accidental overuse and ensure credits
                      last the month
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
