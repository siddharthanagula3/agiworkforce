...
// Real one-pixel JPEG generated by the test toolchain. Keeping valid bytes here
// ensures provider-response tests exercise structure validation, not merely a
// file-signature prefix.
...
vi.mock('@agiworkforce/types', async () => {
  ...
  // image model uses the 'gemini' branch. The mocked
...
describe('POST /api/media/image/generate', () => {
  ...
  // =========================================================================
  // Removed provider compatibility value
  // =========================================================================
