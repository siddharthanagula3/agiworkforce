/**
 * Tool Data Normalizers
 *
 * Pure helper functions for normalizing tool names, mapping to artifact types,
 * extracting MCP text blocks, and normalizing inline tool data payloads.
 * No React dependency — these are stateless utilities.
 */
