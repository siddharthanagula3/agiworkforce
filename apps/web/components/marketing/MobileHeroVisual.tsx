  ...
  return (
    <div className="agi-mobile-hero-wrap">
      ...
      <div className="agi-mobile-store-col">
        <span className="agi-store-soon">Coming Soon</span>
        <a className="agi-store-btn" aria-label="Download on the App Store" tabIndex={-1}>
          <AppleIcon />
        ...
        <a className="agi-store-btn" aria-label="Get it on Google Play" tabIndex={-1}>
          <PlayIcon />
          <div className="agi-store-text">
