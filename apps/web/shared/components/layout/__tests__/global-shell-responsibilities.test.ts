...
const HOSTS = {
  ...
  productProviders: path.join(APP_DIR, 'ProductRuntimeProviders.tsx'),
...
const RESPONSIBILITIES: readonly ShellResponsibility[] = [
  ...
  { concern: 'product capabilities', host: 'productProviders', symbol: 'CapabilityProvider' },
  ...
  { concern: 'push notifications', host: 'runtimeMounts', symbol: 'WebPushOptIn' },
  { concern: 'modal stack', host: 'productProviders', symbol: 'SettingsModalProvider' },
  ...
  { concern: 'support email', host: 'accountMenu', symbol: 'contactMailto' },
