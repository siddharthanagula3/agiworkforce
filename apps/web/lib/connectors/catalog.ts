...
export const CONNECTOR_CAPABILITIES: Readonly<Record<string, ConnectorCapabilityRecord>> = {
  ...
  stripe: mcpConnector('stripe', 'api-key', 'high-impact'),
  ...
  airtable: mcpConnector('airtable', 'api-key', 'read-write'),
  monday: mcpConnector('monday', 'api-key', 'read-write'),
  clickup: mcpConnector('clickup', 'api-key', 'read-write'),
  trello: mcpConnector('trello', 'api-key', 'read-write'),
  todoist: mcpConnector('todoist', 'api-key', 'read-write'),
  basecamp: mcpConnector('basecamp', 'oauth2', 'read-write'),
  evernote: mcpConnector('evernote', 'oauth2', 'read-write'),
  vercel: mcpConnector('vercel', 'api-key', 'high-impact'),
  sentry: mcpConnector('sentry', 'api-key', 'read-write'),
  datadog: mcpConnector('datadog', 'api-key', 'read-write'),
  pagerduty: mcpConnector('pagerduty', 'api-key', 'read-write'),
  ...
  cloudflare: mcpConnector('cloudflare', 'api-key', 'high-impact'),
  ...
  square: mcpConnector('square', 'api-key', 'high-impact'),
  plaid: mcpConnector('plaid', 'api-key', 'high-impact'),
  ...
  posthog: mcpConnector('posthog', 'api-key', 'read-write'),
  segment: mcpConnector('segment', 'api-key', 'read-write'),
  mixpanel: mcpConnector('mixpanel', 'api-key', 'read-write'),
  huggingface: mcpConnector('huggingface', 'api-key', 'read-write'),
