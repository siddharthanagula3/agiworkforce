...
export const OBSERVABILITY_ATTRIBUTE = {
  ...
  protocolVersion: 'agi.protocol.version',
  dataRegion: 'agi.data.region',
  trustMode: 'agi.trust_mode',
  workspaceKind: 'agi.workspace.kind',
  requestMode: 'agi.request.mode',
  denialLayer: 'agi.denial.layer',
  denialReason: 'agi.denial.reason',
  rejectionKind: 'agi.rejection.kind',
  rejectionReason: 'agi.rejection.reason',
  turnOutcome: 'agi.turn.outcome',
  cacheOutcome: 'agi.cache.outcome',
