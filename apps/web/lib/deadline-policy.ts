...
export const SETTINGS_API_ROUTE_DEADLINE_MS = 15_000;

export const CONVERSATION_API_ROUTE_DEADLINE_MS = 15_000;

export const SHARE_CONVERSATION_CLIENT_DEADLINE_MS = CONVERSATION_API_ROUTE_DEADLINE_MS;

export const BILLING_API_ROUTE_DEADLINE_MS = 25_000;
