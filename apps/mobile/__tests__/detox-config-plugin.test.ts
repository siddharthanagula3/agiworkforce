/**
 * Regression coverage for the local Detox config plugin.
 *
 * The Android project is generated by Expo prebuild. These transforms must be
 * deterministic and idempotent or a clean prebuild will silently remove the
 * native Detox runner used by the mobile screenshot and end-to-end suites.
 */
