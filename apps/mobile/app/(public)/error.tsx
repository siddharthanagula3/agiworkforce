...
export default function PublicErrorBoundary({ error, retry }: ErrorBoundaryProps) {
  ...
  return (
    <SafeAreaView className="flex-1" style={{ backgroundColor: colors.surfaceBase }}>
      <View className="flex-1 items-center justify-center px-8">
        ...
        >
          Setup stopped partway through. Try again, or go back.
        </Text>
        <Text
        ...
        <Pressable
          onPress={() => {
            ...
            else router.replace({ pathname: ROOT_ROUTE });
          }}
