...
- Mobile mid-conversation Local-to-BYOK model switches now show a real preview modal backed by the shared handoff scanner instead of the previous placeholder, including redacted payload text, findings, and preview-hash evidence.
