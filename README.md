...
- **Multi-provider model routing**: Catalog of 39 models across 22 providers:
...
| `packages/`                 | 29 shared TypeScript packages outside the provider adapters (types, routing, model-registry, runtime, MCP, artifacts, UI, etc.)                                                                              |
