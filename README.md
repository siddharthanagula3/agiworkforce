...
| `packages/`                 | 29 shared TypeScript packages outside the provider adapters (types, routing, runtime, MCP, artifacts, UI, etc.)                                                                                              |
