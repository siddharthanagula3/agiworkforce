...
- **Multi-provider model routing**: Catalog of 400 models across 22 providers:
...
| `packages/`                 | 33 shared TypeScript packages outside the provider adapters (types, routing, model-registry, runtime, MCP, artifacts, UI, etc.)                                                                              |
