-- Migrated from apps/web/supabase/migrations/20260108000004_fix_stripe_webhook_idempotency.sql on 2026-05-05.
-- See docs/plans/UNIFIED_LAUNCH_PLAN.md §1 P0 #1 (WEB-STRIPE-RPC-MISSING).
--
-- Original: 20260108000004_fix_stripe_webhook_idempotency.sql
