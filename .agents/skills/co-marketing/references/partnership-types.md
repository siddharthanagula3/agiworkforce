...
Adapted from Corey Haines's _Founding Marketing_, Ch. 11 — "Partnerships tap into existing audiences." The fastest way to reach customers is through companies that already have their attention.
...
**Permissionless co-marketing (Notion's coined move) — the single most actionable idea in the chapter.** You don't need a signed partnership to ride a bigger brand. Notion built and published templates _for_ Airbnb, Amazon, and Tesla — no permission, no contract — capturing search demand and brand halo from companies far larger than itself. **Build assets around brands your audience already loves; let the association do the work.**
...
- **Grammarly's Chrome Web Store extension** took it from **0 to 10M users** — the store _was_ the acquisition channel.
...
**When to choose this:** if a single platform owns your buyer's daily workflow, being _inside_ it beats trying to pull users out to your own site.
