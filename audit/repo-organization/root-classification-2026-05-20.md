...
| `AGIWORKFORCE_IMPLEMENTATION_LOG.md` | move-archive   | Historical implementation log.                                              |
| `MASTER_PLAN.md`                     | move-docs      | Historical/current mixed; move to `docs/plans` or archive after link audit. |
| `REFERENCE_INDEX.md`                 | move-docs      | Move under `docs/reference/` or `audit/reference-index/`.                   |
| `REFERENCE_STRUCTURE.md`             | move-docs      | Move under `docs/reference/` or `audit/reference-index/`.                   |
...
1. Move `move-reports` files into `reports/root-scratch-archive/2026-05-20/`.
2. Decide whether `MASTER_PLAN.md` is current enough for `docs/plans/` or should be archived.
