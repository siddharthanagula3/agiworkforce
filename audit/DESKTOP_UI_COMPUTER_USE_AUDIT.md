...
## Follow-Up Pass: Settings Connector Polish

Status: Current patch, 2026-06-04
Build under audit: `/Users/siddhartha/.codex/worktrees/4ec1/agiworkforce/target/release/bundle/macos/AGI Workforce.app`
Reference set:

- `/Users/siddhartha/Desktop/claude settings modal`
- `/Users/siddhartha/Desktop/claude modal free account`
- `/Users/siddhartha/Desktop/claude_reference`
- `/Users/siddhartha/Desktop/claude_reference/claude-connectors`

Audit rule: click through the running desktop app first, record issues, batch fixes, then rebuild once.

| Status                 | Screenshot                                                                           | Screen / flow                       | What looked wrong                                                                                                                               | Reference used                                                                                                        | File changed                                                                                                            | Fix made                                                                                                                                                     | Recheck screenshot |
| ---------------------- | ------------------------------------------------------------------------------------ | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------ |
| fixed in current patch | `audit/desktop-ui-computer-use/settings-modal-open-keyboard-20260604-170532.png`     | Settings modal / Tools nav          | Tools are correctly first-level Settings entries, but connector cards previously used emoji/generic fallback marks when official images failed. | Claude Settings modal and Claude connector directory cards                                                            | `apps/desktop/src/features/connectors/ConnectorGallery.tsx`                                                             | Switched connector mark fallback to bundled official `simple-icons` brand SVGs and neutral MCP plug icon only; removed emoji rendering from connector marks. | pending            |
| fixed in current patch | `audit/desktop-ui-computer-use/settings-modal-open-keyboard-20260604-170532.png`     | Settings / Skills and Plugins       | Intro areas were boxed cards, which read more generic than Claude's flat Settings rows.                                                         | Claude Settings modal                                                                                                 | `apps/desktop/src/features/settings/tabs/Skills/index.tsx`, `apps/desktop/src/features/settings/tabs/Plugins/index.tsx` | Replaced boxed intro cards with flat section headers and dividers.                                                                                           | pending            |
| open                   | `audit/desktop-ui-computer-use/current-settings-state-20260604-171846.png`           | Settings / Connectors               | Connectors still has too much diagnostic/internal copy and does not yet match the compact Claude-style installed/available connector list.      | `/Users/siddhartha/Desktop/claude modal free account`, `/Users/siddhartha/Desktop/claude_reference/claude-connectors` | none in this patch                                                                                                      | Logged for the next batch; current patch only removes fake connector artwork fallback.                                                                       | pending            |
| open                   | `audit/desktop-ui-computer-use/settings-connectors-scroll-audit-20260604-173330.png` | Settings / Connectors lower content | Server Health says 0 of 8 connected while individual actions can mark connectors connected, which reads inconsistent and demo-risky.            | Claude Settings extensions and connector detail references                                                            | none in this patch                                                                                                      | Logged for backend/store reconciliation before demo.                                                                                                         | pending            |
| open                   | `audit/desktop-ui-computer-use/settings-skills-audit-20260604-171930.png`            | Settings / Skills                   | Skills still reads like a marketplace dashboard instead of a compact Settings-owned list.                                                       | Claude connector/skill directory modal references                                                                     | none in this patch                                                                                                      | Logged for redesign in the next settings batch.                                                                                                              | pending            |
| open                   | `audit/desktop-ui-computer-use/settings-agents-audit-20260604-172120.png`            | Settings / Agents                   | Agents is still showing older execution/config toggles instead of the real custom-agent CRUD surface requested for demo.                        | Claude Settings modal layout                                                                                          | none in this patch                                                                                                      | Logged for replacement with real AgentsSettings surface.                                                                                                     | pending            |
| open                   | `audit/desktop-ui-computer-use/settings-models-keys-audit-20260604-172730.png`       | Settings / Models & Keys            | Local Models section is clipped behind the sticky footer at the bottom of the modal.                                                            | Claude Settings modal content scroll behavior                                                                         | none in this patch                                                                                                      | Logged for modal scroll/footer spacing fix.                                                                                                                  | pending            |
| open                   | `audit/desktop-ui-computer-use/settings-notifications-audit-20260604-172900.png`     | Settings / Notifications            | Toggle controls are too low-contrast on the right edge.                                                                                         | Claude Settings modal toggle styling                                                                                  | none in this patch                                                                                                      | Logged for control contrast pass.                                                                                                                            | pending            |
| open                   | `audit/desktop-ui-computer-use/reopen-new-window-audit-20260604-174200.png`          | Window behavior                     | Closing the main window with Cmd+W did not immediately recreate a usable window on app activation/open.                                         | Claude Desktop / ChatGPT Desktop window behavior                                                                      | none in this patch                                                                                                      | Logged for Tauri window lifecycle follow-up.                                                                                                                 | pending            |
