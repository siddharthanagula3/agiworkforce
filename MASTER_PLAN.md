...
| Phase C — PNG-grounded features   | ✅ 10/15 shipped       | #C2 desktop adaptive thinking ✓ (291bf6ccb), #C6 web slash-cmds modal ✓ (07844d4b8), #C9 mobile offline queue ✓ (798a25ac1), #C10 mobile theme prefs scaffold ✓ (720a7fd95), #C11 chrome ext pairing flow ✓ (887a02b10), #C12 chrome ext conversation history ✓ (75e86d545), #C13 vscode chat-in-editor WebviewPanel ✓ (ad196dca0 + 5ae8cfefd wiring), #C14 vscode @mention sidebar ✓ (c90359068), #C8 web homepage verified-shipped. Pending #C1 Cowork tab, #C3 submenu nesting, #C4 Account/Billing tabs, #C5 partner perks, #C7 Show thinking, #C15 marketplace screenshots                                                                                                                                                                                                   |
